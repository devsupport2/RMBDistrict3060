...
<li class="breadcrumb-item active" aria-current="page" style="color:white"> Reset Password </li>
</ol>
</nav>
...
<div class="main-form ">
<form id="contact-form" action="#" method="post" data-toggle="validator" ng-submit="resetPassword()">
<div class="row">

<!-- <div class="col-md-12">
<div class="singel-form form-group">
<input type="email" id="email" name="email" ng-model="email" class="form-control" placeholder="Registered Email" autofocus>	
