...
<title>Refund and Cancellation | RMB District 3060 </title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 blog-content">
							<h1 style="color: #4e4e4e;text-align:center;"> Refund and Cancellation</h1>
							<!-- <h2> </h2> -->
							<p><i class="fa fa-caret-right" aria-hidden="true"></i> In the event, any event is cancelled or postponed for whatever reason, the Company will attempt to refund the amount as per the policy.</p>
							<p><i class="fa fa-caret-right" aria-hidden="true"></i> Cancellations made 7 days or more in advance of the event date, will receive a 100% refund after deducting charges. Cancellations not permitted 7 days prior to the event and there will be no refund.</p>
							<p><i class="fa fa-caret-right" aria-hidden="true"></i> The refund will be done after adjusting the payment gateway charges and any administration charges defined by the Company.</p>
							<p><i class="fa fa-caret-right" aria-hidden="true"></i> The refund will be provided only as a bank transfer to the account from where the payment is made.</p>
							<!-- <p><i class="fa fa-caret-right" aria-hidden="true"></i> For cancellation, an email with transaction details shall be sent to <a href="">events@rmbbangalore.org</a> 7 days prior to the event.</p> -->
						</div>
				<!-- about cont -->
...
<p> Rotary Means Business Fellowship chapter of Vadodara Rotary International District 3060 Rotary Means Business is a Fellowship of Rotary International Today Rotarians are embracing the original foundations of what the Rotary Club was based on as we.</p>
				...
				<div class="row">
					...
					<div class="col-lg-5 col-md-5 col-sm-6">
						<div class="footer-link">
							...
							<ul>
								<li><a href="#"><i class="fa fa-angle-right"></i> About
										RMBF Erode </a></li>
								<li><a href="#"><i class="fa fa-angle-right"></i> Board
										of Directors </a></li>
								<li><a href="#"><i class="fa fa-angle-right"></i>
										Committees & Chairs </a></li>
								<li><a href="#"><i class="fa fa-angle-right"></i>
							...
							<ul>
								<li><a href="#"><i class="fa fa-angle-right"></i>
										Events </a></li>
								<li><a href="#"><i class="fa fa-angle-right"></i> Media
								</a></li>
								<li><a href="#"><i class="fa fa-angle-right"></i>
										Calendar </a></li>
								<li><a href="#"><i class="fa fa-angle-right"></i>
					...
					<div class="col-lg-2 col-md-6 col-sm-6">
						<div class="footer-link support">
							...
							<ul>
								...
								<li><a href="#"><i class="fa fa-angle-right"></i> Terms
										& Conditions </a></li>
								<li><a href="#"><i class="fa fa-angle-right"></i>Privacy
										Policy</a></li>
				...
				<div class="row">
					<div class="col-md-8">
						<div class="copyright text-md-left text-center pt-15">
							<p> Content © 2020 RMBF Erode | Powered by: Astar Technologies </p>
	...
	<!--====== Magnific Popup js ======-->
	<script
		src="<%=request.getContextPath()%>/resources/front/js/jquery.magnific-popup.min.js"></script>

	<!--====== Counter Up js ======-->
	<script
		src="<%=request.getContextPath()%>/resources/front/js/waypoints.min.js"></script>
	<script
		src="<%=request.getContextPath()%>/resources/front/js/jquery.counterup.min.js"></script>

	<!--====== Nice Select js ======-->
	<script
		src="<%=request.getContextPath()%>/resources/front/js/jquery.nice-select.min.js"></script>

	<!--====== Nice Number js ======-->
	<script
		src="<%=request.getContextPath()%>/resources/front/js/jquery.nice-number.min.js"></script>
	...
	<!--====== Validator js ======-->
	<script
		src="<%=request.getContextPath()%>/resources/front/js/validator.min.js"></script>

	<!--====== Ajax Contact js ======-->
	<script
		src="<%=request.getContextPath()%>/resources/front/js/ajax-contact.js"></script>
...
<script src="js/map-script.js"></script>-->
	...
	<script
		src="<%=request.getContextPath()%>/resources/front/js/index.js"></script>
	...
	<script>
		$('document').ready(
				function() {
					...
					var n = d.getFullYear();
					var a = "Content © " + n
							+ " RMBF Erode | Powered by: Astar Technologies";
