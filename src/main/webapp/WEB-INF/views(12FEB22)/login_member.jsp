...
<body ng-app="rcbs" ng-controller="eventDetailCtrl" ng-cloak>
...
<li class="breadcrumb-item active" aria-current="page" style="color:white"> Login </li>
</ol>
</nav>
...
<div class="main-form ">
<form id="contact-form" action="#" method="post"  ng-submit="checkFrontLogin(<%= request.getParameter("membertype")%>)" novalidate>
<div class="row">
...
<button ng-click="checkMemberLogin(<%= request.getParameter("eid")%>,'<%= request.getParameter("membertype")%>')" class="main-btn btn-block" >Sign in</button>
</div> <!-- singel form -->
</div> 
