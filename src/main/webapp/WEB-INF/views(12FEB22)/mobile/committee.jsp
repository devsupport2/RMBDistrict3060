...
<title>  Committee | RMB District </title>
...
<body ng-app="rcbs" ng-controller="MobileIndexCtrl" class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="homepage"  ng-cloak>
...
<h5 class="mb-0"> committees & chairs </h5>
</a>
</div>
...
<div class="card col-12 shadow-sm border-0 mb-3"   ng-repeat="item in MembersCommitteedata">
...
<p class="text-secondary mb-0 truncate">{{item.designation_name}} </p>
