...
<title> Members Details | RMB District 3060 </title>
...
<section id="page-banner"  style="background: #e9ecef">
	...
	<li class="breadcrumb-item active" aria-current="page">  Members Details </li>
	</ol>
	</nav>
...
<br>
<div class="row">
<div class="card mb-3" style="width:98%;margin-left: 15px;" ng-repeat="item in getMemberForMembersDirectory | filter: { fellowship_id: fellowship_id}">
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">{{item.memberFirstName}} {{item.memberLastName}} <br></h5>
     <!--    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
       -->
      <p class="card-text">{{item.businessCategoryName}} </p>
			<p class="card-text" > {{item.memberCompanyName}}</p>
     ...
     <div class="col-md-2">
  <button  data-toggle="modal" data-target="#myModal" type="submit" name="submit" class="btn btn-submit btn-lg btn-block text-center"ng-click="getMemberDetailById(item.memberId)">
									<i class="fa fa-envelope-o"></i>
									<span class="font-12"> Send Message </span>
		...
		<%-- <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12"  ng-repeat="item in getMemberForMembersDirectory | filter: { fellowship_id: fellowship_id}">
