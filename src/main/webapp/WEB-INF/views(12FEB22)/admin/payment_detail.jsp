...
<html lang="en">
	...
	{ %>
	<body ng-app="rcbs" ng-controller="myPaymentCtrl" ng-init="getpayment(<%= request.getParameter("memberid")%>)" ng-cloak>
	<%}
	else
	{%>
	<body ng-app="rcbs" ng-controller="myPaymentCtrl" ng-init="getpayment(<%= session.getAttribute("memberid")%>)" ng-cloak>
	<%} %>
								...
								<div class="row">
									...
									<div class="col-md-10">
										<div style="padding: 1px 10px 0px 0px;  margin-top: -20px;">
											<nav aria-label="...">
												<ul class="pager">													
													<li class="next"><a href="<%=request.getContextPath() %>/manageRmbDistrict/manage_members">Next</a></li>
												</ul>
											</nav>
										</div>
									</div>
