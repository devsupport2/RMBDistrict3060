		    				...
		    				<ul class="nav navbar-nav">		    					
		    					<li class="dropdown">
		    						...
		    						<ul class="dropdown-menu">
		    							...
		    							<li><a
										href="<%=request.getContextPath()%>/manageRmbDistrict/attendance"
										onclick="javascript:window.location.reload();">Event
		    					...
		    					<li class="dropdown">
		    						...
		    						<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/manage_advertisement" onclick="javascript:window.location.reload();">AdvertiseMent</a></li>
		    						<%} %>
		    					...
		    					<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/readExcel" onclick="javascript:window.location.reload();">Import Members </a></li>
		    					<%} %>
		    								...
		    								<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/fellowship_fees" onclick="javascript:window.location.reload();">Manage Fellowship Fees</a></li>
		    								<%if(session.getAttribute("roleId").equals("1")) { %>
		    								<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/manage_district_fees" onclick="javascript:window.location.reload();">Manage District Due Payment Fees</a></li>
		    								<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/manage_chapter" onclick="javascript:window.location.reload();">Manage Email-Relay</a></li>	
		    	                 ...
		    	                 <li><a href="<%= request.getContextPath()%>/manageRmbDistrict/manage_clubs" onclick="javascript:window.location.reload();">Rotary Clubs</a></li>
		    	                 	<%if(session.getAttribute("roleId").equals("1")) { %>
		    	                 	
		    							<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/manage_fellowship" onclick="javascript:window.location.reload();">RMB Fellowships</a></li>
		    							...
		    							<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/manage_admin" onclick="javascript:window.location.reload();">RMBF Admins</a></li>
  							
		    							<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/manage_slider" onclick="javascript:window.location.reload();">Sliders</a></li>
		    							
		    							
<li><a
										href="<%=request.getContextPath()%>/manageRmbDistrict/manage_social_media_links"
										onclick="javascript:window.location.reload();">Social
											Media Links</a></li>
		    					...
		    					<li class="dropdown">
		    						...
		    						<ul class="dropdown-menu">
		    							<%if(session.getAttribute("roleId").equals("1")) { %>
		    							<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/total_chapter_summary" onclick="javascript:window.location.reload();">All Chapter's Summary</a></li>
		    							<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/admin_summary" onclick="javascript:window.location.reload();"> Chapter's Summary</a></li>
		    						<%} %>
