...
<html lang="en">
	...
	{ %>
	<body ng-app="rcbs" ng-controller="myFamilyDetailCtrl" ng-init="getspousedetail(<%= request.getParameter("memberid")%>)" ng-cloak>
	<%}
	else
	{%>
	<body ng-app="rcbs" ng-controller="myFamilyDetailCtrl" ng-init="getspousedetail(<%= session.getAttribute("memberid")%>)" ng-cloak>
	<%} %>
