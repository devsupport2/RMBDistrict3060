<div class="modal-dialog" role="document" id="configform">
<div class="modal-content">
<div  class="modal-header bg-gradient-primary">
<h5 class="modal-title text-white" id="exampleModalLabel"> Business Given</h5>
<button class="close text-white" type="button" data-dismiss="modal" id="configreset" aria-label="Close">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">												
		<lable>Business Given to<font color="red" size="3">*</font></lable>
