...
<body ng-app="rcbs" ng-controller="passwordCtrl">
...
<li class="breadcrumb-item active" aria-current="page" style="color:white"> Forgot Password </li>
</ol>
</nav>
...
<div class="main-form ">
<form id="contact-form" action="#" method="post" data-toggle="validator" ng-submit="forgetPassword()">
<div class="row">

<div class="col-md-12">
<div class="singel-form form-group">
<input name="name" type="email"  name="email" id="email" required ng-model="email"  placeholder="Enter Email Address..." required="required">
...
<button type="submit" class="main-btn btn-block" ng-click="checkFrontLoginForMembersDirectory()"> Submit </button>
</div> <!-- singel form -->
</div> 
