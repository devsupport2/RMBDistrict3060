...
<script src="<%=request.getContextPath() %>/resources/admin/js/controller/SearchMember.js"></script>
	<script 
...
<body  ng-app="rcbs" ng-controller="SearchMemberCtrl" ng-init="getFellowshipById()" ng-cloak>
...
<ul class="nav float-left" id="myTab" role="tablist">
 <!-- ng-options="item.fellowship_id as item.fellowship_name for item in fellowshipnamedata " -->
	<select ng-model="fellowship_id" id="fellowship_id" name="fellowship_name" ng-change="getAllMemberDirectory(fellowship_id)"  class="form-control input-lg2">
				
			<option value=""selected>Select Fellowship Name</option>
			<option ng-repeat="items in fellowshipnamedata" value="{{items.fellowship_id}}">{{items.fellowship_name}}</option>
...
<form action="#">
<input type="text" id="search" name="search" ng-model="search" class="form-control input-lg" placeholder="Search Members here..." ng-keyup="$event.keyCode == 13 ? searchmember() : null" >
...
<div class="row">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12"  ng-repeat="item in getMemberForMembersDirectory | filter: { fellowship_id: fellowship_id} | filter : search">
			...
			<%-- 	<img class="img-responsive" src="<%=request.getContextPath() %>/resources/front2/img/members/t-1.jpg"> --%>
				...
				<img  class="img-responsive" src="{{item.memberProfilePicture}}" onerror="this.onerror=null; this.src='<%=request.getContextPath() %>/resources/admin/images/UserImg.png'" alt="" ng-if="item.memberProfilePicture != ''"/>
				<img class="img-responsive" src="<%=request.getContextPath() %>/resources/admin/images/UserImg.png" alt=""  ng-if="item.memberProfilePicture == ''">														
		...
		<p class="left1" ng-if="!item.memberCompanyName">  <span style="visibility: hidden;">mk </span></p>
				<p class="left1" ng-if="!item.businessCategoryName"> <span style="visibility: hidden;">mk </span></p>
