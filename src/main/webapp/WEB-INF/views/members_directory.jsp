...
<body  ng-app="rcbs" ng-controller="membersDirectoryCtrl" ng-cloak  ng-init="getFellowshipById()">
...
<ul class="nav float-left" id="myTab" role="tablist">
 <!-- ng-options="item.fellowship_id as item.fellowship_name for item in fellowshipnamedata " -->
		<select ng-model="fellowship_id"  class="form-control " >
...
<div class="row">
		...
		<%if(session.getAttribute("memberid") != null && session.getAttribute("memberstatus").equals("y")) {%>
				...
				<a style="font-weight: normal;
				    line-height: 36px;"href="<%=request.getContextPath()%>/member_details?id={{item.memberId}}" class="main-btn btn-block btn-sm"> View Details </a>
				</div>
		<%}	else {%>	
		<div class="button">
				<a style="font-weight: normal;
