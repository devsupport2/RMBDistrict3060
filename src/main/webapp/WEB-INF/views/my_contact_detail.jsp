...
<div class="form-group row">
		...
		<div class="box-header with-border card shadow mb-4 col-lg-12" style="padding-top:15px;background-color: #f8f9fc;">
					...
					<div class="row">
						...
						<input type="text"id="companyname" name="companyname" ng-model="companyname" class="form-control " placeholder="Company Name" >
						</div>
				...
				<input class="form-control" id="occupation" name="occupation" ng-model="occupation"  type="text" placeholder="Occupation" >
				</div>
				
				
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<label>Designation<!-- <font color="red" size="3">*</font>  --></label>
				<input type="text" id="designation" name="designation" ng-model="designation" class="form-control " placeholder="Designation" >
				</div>
			...
			<div class="form-group row">
					 ...
					 <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						...
						<input type="text" id="businessnature" name="businessnature" ng-model="businessnature" class="form-control " placeholder="Business Nature" >
					</div>
	...
	<div class="form-group row">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" id="citynamework" name="citynamework" ng-model="citynamework" ng-init="citynamework = 'Vadodara'" class="form-control input-lg1" placeholder="City" >
						</div>
					</div>
				</div>
...
<div class="form-group row">	
				...
				<div class="col-md-3 text-left">
					...
					<button type="submit"  ng-click='redirectmemberdetail(memberid,2)'  class="btn btn-md btn-success btn-block"><i ng-show="spin == 1" class="fa fa-spin fa-spinner" aria-hidden="true"></i> Previous
					<i class="fa fa-plus" aria-hidden="true" ng-if="nospin == 1"></i><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i>
					</button>	</div>	
					<div class="col-md-2 text-left"> </div>		
					<div class="col-md-4 text-left"> </div>									
				<div class="col-md-3 text-right">
					<button type="submit" ng-click="editcontactdetail(memberid, membercategoryid, tenureplan, 2)"  class="btn btn-md btn-success btn-block">Update
		...
		if (input.files && input.files[0]) {
			...
			reader.onload = function(e) {
			    ...
			    img.onload = function() {
			        ...
			        {
			        	alert("Minimum image size should be 700px X 700px");
			        	$('#target').attr('src', "");
			        	document.getElementById("image").value = null;
			        }
			        else
			        {
			        	//$('#target1').css("min-height", "300px");
					    //$('#target').css("max-width", "250px");
