...
<section id="page-banner"  style="background: #e9ecef">
	...
	<li class="breadcrumb-item active" aria-current="page"> Committees & Chairs  </li>
	</ol>
	</nav>
...
<h5> RMB District 3060 Committees & Chairs 20-21 </h5>
</div>


<div class="row">

	<div class="col-lg-3  col-md-3 col-sm-6  col-12" ng-repeat="item in MembersCommitteedata">
		<div class="singel-teachers mt-30 text-center">
		
			<div class="image">
				<img src="{{item.memberProfilePicture}}" alt="{{item.memberFirstName}}">
			</div>
			
			<div class="cont">
				<a href="#"><h6> {{item.memberFirstName}} {{item.memberLastName}} </h6></a>
				<span> {{item.designation}} </span> <br>
					<span> {{item.fellowship_name}} </span>
			</div>
		</div> <!-- singel teachers -->
	</div>
