...
<p class="card-category mb-10"> <a href="<%=request.getContextPath() %>/meber_business_received" >  Business Given </a></p>

<h3 style="font-size: 42px; font-weight: 700;" class="card-title"> <small>₹</small>
 <a href="<%=request.getContextPath() %>/meber_business_received" >  {{getFirstGivendata.Businessgiven}} </a></h3>
...
<p class="card-category mb-10"><a href="<%=request.getContextPath() %>/member_bussiness_given" > Business Received</a> </p>
<h3 style="font-size: 42px; font-weight: 700;" class="card-title"> 
<a href="<%=request.getContextPath() %>/member_bussiness_given" >
