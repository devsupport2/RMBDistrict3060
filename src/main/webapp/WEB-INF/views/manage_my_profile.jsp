...
<div class="form-group row">
		...
		<div class="col-lg-3 col-md-3">
			<div class="profile-sidebar">
				...
				<img class="img-responsive" src="{{profilepicture}}" alt="" />
			...
			<div class="col-lg-3"></div>
				<div class="col-lg-3"> </div>
					...
					<label> Fellowship Name  </label>
						<select class="form-control dropdownparrow" ng-model="fellowship_id" id="fellowship_id" name="fellowship_id"    ng-init="fellowship_id = 2" ng-options="items.fellowship_id as items.fellowship_name for items in getAllFellowshipNameList" style=" background-color: #5b5fe424; color: black;" >
							<option value="" selected> Fellowship Name</option>
							<!-- <select ng-model="fellowship_id" id="fellowship_id1" name="fellowship_name" ng-init="fellowship_id = 2" ng-options="items.fellowship_id as items.fellowship_name for items in getAllFellowshipNameList" ng-change="FellowshipByFees(fellowship_id)" class="form-control input-lg2"> -->
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						...
						<label> Type Of Member </label>
								<select ng-model="membercategoryname" style=" background-color: #5b5fe424; color: black;" readonly id="membercategoryname" name="membercategoryname" ng-options="item.memberCategoryId as item.memberCategoryName for item in getmembercategory" class="form-control input-lg2 dropdownparrow">
...
<div class="form-group row">
	 ...
	 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		 ...
		 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-lg-3">
						<div class="form-group">
							...
							<input   class="KendoDate" id="anniversarydob" title="datepicker2" placeholder="DD/MM/YYYY" style="width: 100%;"/>
						</div>
					</div>		
		...
		<div class="form-group row">
			 ...
			 <div class="form-group">
					<label>Nationality</label><!-- 	ng-options="item.memberTypeId as item.memberTypeName for item in getmembertype" -->
					<select ng-model="membertypename" id="membertypename" name="membertypename"  ng-options="item.countryId as item.countryName for item in getcountry" ng-init="countryname = 1" class="form-control input-lg2">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" id="passportnumber" name="passportnumber" ng-model="passportnumber" class="form-control input-lg1" placeholder="Passport Number" disallow-spaces >
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="form-group">
						<label>PAN Number</label>
						<input type="text" id="pannumber" name="pannumber" ng-model="pannumber" class="form-control input-lg1" placeholder="PAN No" disallow-spaces >
					</div>
				</div>
			</div>    
...
<div class="row">		<!------------------------------------ Row Start -->							
				...
				<div class="col-md-4 text-right">
					<button type="submit" ng-click="editmemberdetail(memberid, 2)"   class="btn btn-success tablinks"> Update & Next
					<i ng-show="spin == 1" class="fa fa-spin fa-spinner" aria-hidden="true"></i>
					</button>			
				</div>
				<div class="col-md-2 text-right">
					<button type="submit" ng-click="redirectcontactdetail(memberid, 2)"  class="btn btn-md btn-success btn-block">Next</button>			
				<!-- <i ng-show="spin == 1" class="fa fa-spin fa-spinner" aria-hidden="true"></i>  -->
				</div>
...
<div class="modal fade in" id="barcodeModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
