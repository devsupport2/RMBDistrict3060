...
<html lang="en">
	<head>
		...
		<script src="<%=request.getContextPath() %>/resources/admin/js/controller/advertisement.js"></script>
...
.mt-15 {
  margin-top:15px !important;
	...
	<body ng-app="rcbs" ng-controller="AdvertisementCtrl" >
		<%@include file="header.jsp" %>		
		<div class="panel-body">
			<div class="container">
				<div class="row panel panel-primary" style="width:auto;background-color:#eee;">
					<div class="col-md-4" align="center">
						<h3 style="color:#db3615">Manage Advertisement</h3>    
					</div>
					<div class="col-md-2" align="center">
						<div class="form-group"style="margin-top:15px">
							<input ng-model="search" id="search" class="form-control" placeholder="Search Advertisement Title">
						</div>
					</div>					
					...
					<div class="col-md-3 mt-15">
						<div class="form-group" style="color:white;">
							<a href="" data-toggle="modal" data-target="#AddSlider" class="btn btn-success" style="float:right; margin-bottom: 10px;">Add Advertisement <span class="glyphicon glyphicon-plus"></span></a>
						</div>
				    </div>				
				</div>
				<div class="row">
								...
								<table class="table table-hover">
														<tbody>
															<tr style="color:black">
																<th style="color:black" width="30%">Advertisement TITLE</th>
							...
							<div class="row">
								<div class="col-md-5">
									<div class="form-group">
										...
										<input type="text" id="slidertitleadd" name="slidertitleadd" ng-model="slidertitleadd" placeholder="Advertisement Title" class="form-control">
									</div>
								</div>
								<div class="col-md-5">
									<div class="form-group">
										<label>Advertisement Image <font style="color: red;">*</font></label>
										<input type="file" id="imageadd" name="imageadd" class="form-control"><br>
										<p style="font-size:13px; margin-top:-10px;">Upload minimum 500 * 400 size image for better appearance</p>
									</div>
								</div>
								<div class="col-md-2">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label>Advertisement Title</label>
										<input type="text" id="slidertitle" name="slidertitle" ng-model="slidertitle" placeholder="Advertisement Title" class="form-control">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
					...
					if (input.files && input.files[0]) {
						...
						reader.onload = function(e) {
						    ...
						    img.onload = function() {
						        ...
						        {
						        	alert("Minimum image size should be 500px X 400px");
						        	$('#target').attr('src', "");
