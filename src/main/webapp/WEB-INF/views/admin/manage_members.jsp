												...
												<div class="col-md-1" >
													<!-- <div class="form-group">
													 ...
													 <div class="form-group">
								    					...
								    					<li class="dropdown">
								    						<a href="add_member" class="btn btn-success" style="padding-top: 6px; padding-bottom: 6px;background-color: #449d44;" data-toggle="tooltip" title="Add Member"><i class="fa fa-plus" aria-hidden="true"></i></a>
								    						<ul class="dropdown-menu">	
								    						<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/add_member">Add Members</a></li>	    							
								    							<li><a href="<%= request.getContextPath()%>/manageRmbDistrict/readExcel">Import Members</a></li>
								    						</ul>
								    					</li>
								    				</ul>
								    				</div>
											...
											<div class="table-responsive">
												<table class="table table-bordered">
													<tbody >
														...
														<tr ng-repeat="item in getmember1  | filter: { fellowship_id: fellowship_id} | filter: search" ng-if="item.role_id != 1" style="cursor:pointer;cursor:hand">
															...
															<td style="color:black;" ng-click='redirectmemberdetail(item.memberId)'>{{item.memberFirstName}} {{item.memberMiddleName}} {{item.memberLastName}} <span ng-if="item.user_role_id == 2"> [ {{item.user_role_name}} ] </span> </td>
