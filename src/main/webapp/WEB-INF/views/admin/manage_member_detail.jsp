											...
											<div class="panel-heading" style="border-top: 2px solid blue; background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #e2e2e2), color-stop(1, #fafafa));">
												<div class="row" style="color: #333;">
													...
													<div class="col-md-3" align="right">
														<div class="panel-title1" style="white-space: nowrap;">{{rotaryyeartitle}}</div>
													</div>																									
												</div>
											</div>
											<div class="panel-body">
												...
												<div class="col-md-3" ng-show="<%=session.getAttribute("roleId") %> == '1'">
														<div class="form-group"  >
															...
															<select ng-model="fellowship_id" id="fellowship_id" name="fellowship_name"  class="form-control input-lg2" style="height:46px;">
												...
												<div class="col-md-3"  ng-show="<%=session.getAttribute("roleId") %> == '2'">
														<div class="form-group">
															<label>Fellowship Name<font color="red" size="3">*</font></label>
															<select ng-model="fellowship_id" id="fellowship_id" name="fellowship_name"  class="form-control input-lg2 dropdownparrow" style=" background-color: #5b5fe424; color: black;" disabled >
																<option value=""selected>Select Fellowship Name</option>
																<option ng-repeat="items in getAllFellowshipNameList" value="{{items.fellowship_id}}">{{items.fellowship_name}}</option>
															</select>
														</div>
													...
													<div class="col-md-3">
														...
														<input type="text" disabled="disabled" ng-model="membershipId" class="form-control input-lg2" style=" background-color: #5b5fe424; color: black;"   placeholder="Membership No" />
													</div>
												</div>
												<div class="row">													
													<div class="col-md-3">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="input-group">
																	...
																	<input id="password" name="password" ng-model="password" type="text" class="form-control  input-lg1" value="" placeholder="Password*">                                         
																</div>
															</div>
														</div>
													</div>
