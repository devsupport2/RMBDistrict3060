...
<html lang="en">
	...
	<body ng-app="rcbs" ng-controller="committeeCtrl" ng-init="getCommitieByFellowship(<%=session.getAttribute("fellowshipId") %>,<%=session.getAttribute("roleId") %> )">
				...
				<div class="row panel panel-primary" style="width:auto;background-color:#eee;">
					...
					<div class="col-md-1" align="right" style="margin-top:15px">
						<div class="form-group">
							<a href="#" data-toggle="modal" data-target="#AddModal" class="btn btn-success btn-default" title="Add Board Of Directors" ng-click="getfellowship(<%=session.getAttribute("fellowshipId") %>)"><span class="glyphicon glyphicon-plus"></span></a>
						</div>
					</div>
							...
							<div class="table-responsive">
								<table id="mytable" class="table table-bordred table-striped">
									<thead>
										...
										<th width="30%">Member Name / Fellowship Name</th>																			
									...
									<!-- | startFrom:currentPage*pageSize | limitTo:pageSize -->
										<tr ng-repeat="item in memberscommittee | filter:search | filter: { fellowship_id: fellowship_id}"  style="cursor:pointer;cursor:hand">					
											...
											<td data-toggle="modal" data-target="#EditModal" ng-click='getMembersCommitteeDetail(item.membersCommitteeId)'>{{item.memberFirstName}} {{item.memberLastName}} <br> {{item.fellowship_name}}</td>
										...
										<div class="col-md-8">
											<div class="form-group">
												<label>Member Name<font color="red" size="3">*</font></label>									
													<select ng-model="memberid" id="fellowship_name" name="fellowship_name" class="form-control input-lg2">
