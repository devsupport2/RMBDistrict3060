...
<link href="<%=request.getContextPath() %>/resources/mobile/css/style.css" rel="stylesheet" id="style">
	...
	<script src="<%=request.getContextPath() %>/resources/admin/js/controller/mobile_meeting.js"></script>

</head>

<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="wallet"  ng-app="rcbs" ng-controller="MobileMeetingCtrl"  ng-init="getMemberMeetingsDetailById(<%= session.getAttribute("loginid") %>)"> " ng-cloak>
...
<p class="text-white" ng-hide="given == 2"> Meeting Given</p>
<p class="text-white" ng-show="given == 2"> Meeting Received</p>
</a>
</div>
...
<!-- <div class="col-auto">
<a href="busines-transaction.html" class="">
<div class="icon icon-40 bg-blue-light text-default mb-2 rounded-circle">
    <span class="material-icons"> add </span>
</div>
...
<div class="row mb-2">
<div class="col-6">
<button class="btn px-2 btn-block rounded"  ng-class="{'btn-outline-default': given != 2, 'btn-default' : given == 2 }" ng-click="getMemberMeetingsDetailById(<%= session.getAttribute("loginid") %>)">
GIVEN </button>
</div>
<div class="col-6">
<button class="btn px-2 btn-block rounded"  ng-class="{'btn-outline-default': given == 2, 'btn-default' : given != 2 }" ng-click="getMemberMeetingsDetailByIdRecvied(<%= session.getAttribute("loginid") %>)"> RECEIVED </button>
</div>
</div>
...
<li class="list-group-item pl-0 pr-0" ng-show=" given == 1" ng-repeat="item in getMemberMeetings">
<div class="row align-items-center">
...
<li class="list-group-item pl-0 pr-0" ng-show=" given == 2" ng-repeat="item in getMemberMeetingsdata">
<div class="row align-items-center">
