...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="wallet"  ng-app="rcbs" ng-controller="MobilebusinessReceievdCtrl" ng-init="getMemberBusinessByIdGiven(<%= session.getAttribute("loginid") %>)"> >
...
<!--  <div class="col-auto">
<a href="add-reference.html" class="">
<div class="icon icon-40 bg-blue-light text-default mb-2 rounded-circle">
    <span class="material-icons"> add </span>
 </div>
...
<p class="text-white" ng-hide="given == 2"> Business Given</p>
<p class="text-white" ng-show="given == 2"> Business Received</p>
</a>
</div>
...
<div class="row mb-2">
<div class="col-6">
<button class="btn px-2 btn-block rounded" ng-class="{'btn-outline-default': given != 2, 'btn-default' : given == 2 }" ng-click="getMemberBusinessByIdGiven(<%= session.getAttribute("loginid") %>)">
GIVEN </button>
</div>
<div class="col-6">
<button class="btn px-2 btn-block rounded" ng-class="{'btn-outline-default': given == 2, 'btn-default' : given != 2 }" ng-click="getMemberBusinessById(<%= session.getAttribute("loginid") %>)"> RECEIVED </button>
</div>
</div>
<hr>
...
<li class="list-group-item pl-0 pr-0" ng-show=" given == 0">
...
<div class="col align-self-center pr-0" ng-repeat="item in getMemberMeetingList">
<h6 class="font-weight-normal mb-1"> {{item.meetingDate}} </h6>
<p class="text-secondary"> {{item.inviteeFirstName}} {{item.inviteeLastName}} <i class="fa fa-angle-right ml-5 mr-5"></i> {{item.memberFirstName}}  {{item.memberLastName}} </p>
</div>
...
<li class="list-group-item pl-0 pr-0" ng-repeat="item in getMemberBusiness"  ng-show="given == 1">
<div class="row align-items-center">
...
<h6 class="font-weight-normal mb-1"> {{item.slipDate}} </h6>
<p class="text-secondary"><%=session.getAttribute("membername") %><i class="fa fa-angle-right ml-5 mr-5"></i> {{item.memberFirstName}} {{item.memberLastName}}      </p>
</div>
...
<li class="list-group-item pl-0 pr-0" ng-repeat="item in getMemberBusinessdata"  ng-show="given == 2">
<div class="row align-items-center">
...
<div class="col align-self-center pr-0">
<h6 class="font-weight-normal mb-1"> {{item.slipDate}} </h6>
<p class="text-secondary"> {{item.memberFirstName}} {{item.memberLastName}}  <i class="fa fa-angle-right ml-5 mr-5"></i>  <%=session.getAttribute("membername") %>  </p>
</div>
