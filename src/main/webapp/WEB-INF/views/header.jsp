...
<ul>
<li><span><a href="<%=request.getContextPath() %>/#publication-part"> Media </a></span></li>
<!-- <li><span><a href="#"> Calendar </a></span></li> -->
<li><span><a href="<%=request.getContextPath() %>/contact_us"> Contact </a></span></li>
...
<li class="nav-item">
<a href="<%=request.getContextPath() %>/about_rmb3060"> About RMB District 3060 </a>
</li>
<!--<li class="nav-item"><a href="#"> Board of Directors  </a></li>-->
<li class="nav-item"><a href="<%=request.getContextPath() %>/committees"> Committees & Chairs </a></li>
<li class="nav-item"><a href="<%=request.getContextPath() %>/members_directory"> Members Directory </a></li>
<li class="nav-item"><a href="<%=request.getContextPath() %>/events"> Events </a></li>
...
<script>
$('.header-contact ul li a').on('click',function(event){
	   var $anchor = $(this);
	   $('html, body').animate({
