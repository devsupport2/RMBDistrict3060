app.controller('SearchMemberCtrl', function($scope, $http, $window, $filter, $location, $timeout) {
...
/*	var link = baseUrl+'getMemberForMembersDirectoryByPage?pagesize='+$scope.pageSize+'&startindex='+$scope.currentPage;
	...
	const params = new URLSearchParams(window.location.search);
		...
		//	$scope.editColdWorkPermit(params.get('search'));
			$scope.search=(params.get('search'));
	//		alert($scope.search);
}
	}
	$scope.next = function() {
