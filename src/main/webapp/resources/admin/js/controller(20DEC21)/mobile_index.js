...
$scope.editmemberdetail = function(memberid, temp) {
		...
		if(!$scope.firstname) {
			...
			return;
				...
				$scope.mobileError=1;
				$scope.mobileMsg="Please enter last name";
