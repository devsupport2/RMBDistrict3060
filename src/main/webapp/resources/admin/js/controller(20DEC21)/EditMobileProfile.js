app.controller('EditMobilemanageProfileCtrl',function($scope, $http, $window, $filter, $location) {
	...
	$scope.editmemberdetail = function(memberid, temp) {
		...
		var dateofbirth = document.getElementById("profiledob").value;			
		var bloodgroup = $scope.bloodgroup;	
		var anniversarydate = document.getElementById("anniversarydob").value;
	...
	$scope.invitedbymemberid ="00";		
		$scope.meetingdate = document.getElementById("profiledob").value;		
