	app.controller('AdvertisementCtrl', ['$scope', '$filter', '$http', '$window', '$location' ,function ($scope, $filter, $http, $window, $location){
					    ...
					    var link = baseUrl+'getSlidersByPage1?pagesize='+$scope.pageSize+'&startindex='+$scope.startindex;
						...
						$scope.addSlider = function()
						{
							...
							else
							{
								...
								var link = baseUrl+'addSlider1?slidertitle='+tit2+'&active='+active1+'&redirecturl='+url2+'&target='+target+'&ipaddress='+$scope.ipaddress+'&valuex='+valuex+'&valuey='+valuey+'&valuew='+valuew+'&valueh='+valueh;
							//alert(link);
						...
						$scope.editSlider = function(sliderid)
						{
							...
							else
							{
								...
								var link = baseUrl+'editSlider1?sliderid='+sliderid+'&slidertitle='+tit2+'&active='+active1+'&redirecturl='+url2+'&target='+target+'&sliderimage='+$scope.sliderimage+'&ipaddress='+$scope.ipaddress+'&valuex='+valuex+'&valuey='+valuey+'&valuew='+valuew+'&valueh='+valueh;
								var formData=new FormData();
						...
						{
							deleteSlider = $window.confirm('Are you sure you want to delete Advertisement?');
							if(deleteSlider)
							{
							    angular.forEach($scope.getSliders,
							    		function(item)
							    		{
							    			if (item.selected)
							    			{
							    				var link = baseUrl+'deleteSlider1?sliderid='+item.sliderId;
							    ...
							    $window.location.href = adminurl+'manage_advertisement';
							}
						}
						...
						$scope.setActive = function(sliderid, active)
						{
							...
							var link = baseUrl+'setActiveOrInActiveSlider1?sliderid='+sliderid+'&active='+active+'&ipaddress='+$scope.ipaddress;
