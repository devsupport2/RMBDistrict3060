...
public class AlbumDAOImpl implements AlbumDAO
{
	...
	//	String sql = "select min(ai.album_image_id) as album_image_id, ai.image_title, ai.description, ai.image, a.album_id, a.album_title, a.description from album a, album_image ai where ai.album_id=a.album_id group by ai.album_id, ai.image_title, ai.description, ai.image, a.album_id, a.album_title, a.description "; /*desc*/
		String sql = "select ai.album_image_id, ai.image_title, ai.description, ai.image, a.album_id, a.album_title, a.description from album a left join album_image ai on ai.album_id=a.album_id where ai.album_image_id = (SELECT MIN(album_image_id) FROM album_image WHERE album_id = a.album_id) and a.status = 'y'";
		Connection conn = null;
