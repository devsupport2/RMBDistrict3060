...
public class MemberDAOImpl implements MemberDAO {
        ...
        try {
            ...
            while (rs.next()) {
                members = new Members(rs.getInt("member_id"), rs.getInt("user_type_id"),
                        ...
                        rs.getString("business_category_name"),rs.getString("user_role_name"),rs.getInt("user_role_id"));
                Members.add(members);
            }
            rs.close();
            ps.close();
   ...
   //   String sql = "select fellowship_id,member_id, member_first_name, member_last_name, member_profile_picture,member_email,member_mobile_number from members where status=?  order by member_first_name ";
      String sql="select bc.business_category_name,mm.business_category_id,mm.member_company_name,fellowship_id,member_id, member_first_name, member_last_name, member_profile_picture,member_email,member_mobile_number, member_occupation, member_designation, member_business_nature, member_company_description, member_company_keywords, member_website_name from members mm left join business_category bc on bc.business_category_id=mm.business_category_id where mm.status=? order by member_first_name ";
      Connection conn = null;
      ...
      try {
          ...
          while (rs.next()) {
              members = new Members(rs.getInt("member_id"), rs.getString("member_first_name"),
                      rs.getString("member_last_name"), rs.getString("member_profile_picture"), rs.getString("member_email"), rs.getString("member_mobile_number"),rs.getInt("fellowship_id"), rs.getString("business_category_name"), rs.getString("member_company_name"), rs.getString("member_occupation"), rs.getString("member_designation"), rs.getString("member_business_nature"), rs.getString("member_company_description"), rs.getString("member_company_keywords"), rs.getString("member_website_name") );
              Members.add(members);
          }
          rs.close();
          ps.close();
  ...
  public Members checkCurrentPassword(int memberid, String password) {
    ...
    public void addMemberDetail1(Members member) {
        logger.info("Inside Add Member Detail Impl");
        String sql = "insert into members(user_type_id, membership_number, club_id, member_category_id, member_type_id, member_type, business_category_id, tenure_plan, joining_date, member_name_title, member_first_name, member_middle_name, member_last_name, member_gender, member_date_of_birth, member_anniversary_date, member_blood_group, member_aadhar_number, member_country_id_citizenship, member_passport_number, member_pan_number, member_profile_picture, member_mobile_number, member_email, member_password, member_barcode, member_qrcode, sequence, vocation_id, status, created_by, ip_address,fellowship_id,user_role_id,member_company_name) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {       
            ...
            ps.setString(35, member.getMemberCompanyName());
    ...
    public Members getMemberDetailByMemberId(int memberid) {
        ...
        //  System.out.println(">>>>>>>>>>>>>>>>>>>"+memberid);
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                members = new Members(rs.getString("member_password"), rs.getInt("member_id"), rs.getInt("user_type_id"),
    ...
    public List<Members> getMembersByPage(int pagesize, int startindex) {
        ...
        String sql="select m.user_role_id, uu.user_role_name,cc.club_name,m.member_id,m.fellowship_id, m.user_type_id, m.membership_number, m.club_id, m.member_category_id, m.member_type_id, m.business_category_id, m.tenure_plan, joining_date, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, m.member_gender, m.member_date_of_birth, m.member_anniversary_date, m.member_blood_group, m.member_aadhar_number, m.member_country_id_citizenship, m.member_passport_number, m.member_pan_number, m.member_profile_picture, m.member_email, m.member_address1, m.member_address2, m.member_address3, m.member_state_id, m.member_city_name, m.member_pincode, m.member_mobile_number, m.member_phone_number, m.member_barcode, m.member_qrcode, m.company_logo, m.member_occupation, m.member_designation, m.member_company_name, m.member_business_nature, m.member_company_mobile_number, m.member_company_phone_number, m.member_fax_number, m.member_company_email, m.member_website_name, m.member_company_description, m.member_company_keywords, m.member_company_address1, m.member_company_address2, m.member_company_address3, m.member_company_state_id, m.member_company_city_name, m.member_company_pincode, m.member_communication_address, m.business_goals, m.accomplishments, m.interests, m.networks, m.skills, m.ideal_referral, m.top_product, m.top_problem_solved, m.sequence, m.status,bc.business_category_name ,ff.fellowship_name from members m left join business_category bc on m.business_category_id = bc.business_category_id left join club cc on m.club_id =cc.club_id left join fellowship ff on ff.fellowship_id = m.fellowship_id   left join user_role uu on uu.user_role_id= m.user_role_id where m.status=?  order by m.member_first_name limit ?,?";
        Connection conn = null;
        try {
            conn = dataSource.getConnection();
            PreparedStatement ps = conn.prepareStatement(sql);
        ...
        //  ps.setInt(2, fellowship_id);
            ...
            while (rs.next()) {
                members = new Members(rs.getInt("member_id"), rs.getInt("user_type_id"),
                        ...
                        rs.getString("skills"), rs.getString("ideal_referral"), rs.getString("top_product"),
                        rs.getString("top_problem_solved"), rs.getInt("sequence"), rs.getString("status"),
                        rs.getString("business_category_name"),rs.getString("club_name"),rs.getString("fellowship_name"),rs.getInt("fellowship_id"),rs.getString("user_role_name"),rs.getInt("user_role_id"));
                Members.add(members);
            }
            rs.close();
            ps.close();
    ...
    public List<Members> getMembersByPage(int pagesize, int startindex, int fellowship_id) {
        ...
        List<Members> Members = new ArrayList<Members>();
        String s = "y";
        String sql = "select m.user_role_id, uu.user_role_name, m.member_id,m.fellowship_id as fellowship_id, m.user_type_id, m.membership_number, m.club_id, m.member_category_id, m.member_type_id, m.business_category_id, m.tenure_plan, joining_date, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, m.member_gender, m.member_date_of_birth, m.member_anniversary_date, m.member_blood_group, m.member_aadhar_number, m.member_country_id_citizenship, m.member_passport_number, m.member_pan_number, m.member_profile_picture, m.member_email, m.member_address1, m.member_address2, m.member_address3, m.member_state_id, m.member_city_name, m.member_pincode, m.member_mobile_number, m.member_phone_number, m.member_barcode, m.member_qrcode, m.company_logo, m.member_occupation, m.member_designation, m.member_company_name, m.member_business_nature, m.member_company_mobile_number, m.member_company_phone_number, m.member_fax_number, m.member_company_email, m.member_website_name, m.member_company_description, m.member_company_keywords, m.member_company_address1, m.member_company_address2, m.member_company_address3, m.member_company_state_id, m.member_company_city_name, m.member_company_pincode, m.member_communication_address, m.business_goals, m.accomplishments, m.interests, m.networks, m.skills, m.ideal_referral, m.top_product, m.top_problem_solved, m.sequence, m.status, bc.business_category_name,cc.club_name , ff.fellowship_name from members m left join business_category bc on m.business_category_id = bc.business_category_id left join club cc on m.club_id =cc.club_id left join fellowship ff on ff.fellowship_id = m.fellowship_id   left join user_role uu on uu.user_role_id= m.user_role_id where m.status=? and m.fellowship_id =? order by m.member_first_name limit ?,?";
    
        //String sql = "select m.member_id, m.user_type_id, m.membership_number, m.club_id, m.member_category_id, m.member_type_id, m.business_category_id, m.tenure_plan, joining_date, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, m.member_gender, m.member_date_of_birth, m.member_anniversary_date, m.member_blood_group, m.member_aadhar_number, m.member_country_id_citizenship, m.member_passport_number, m.member_pan_number, m.member_profile_picture, m.member_email, m.member_address1, m.member_address2, m.member_address3, m.member_state_id, m.member_city_name, m.member_pincode, m.member_mobile_number, m.member_phone_number, m.member_barcode, m.member_qrcode, m.company_logo, m.member_occupation, m.member_designation, m.member_company_name, m.member_business_nature, m.member_company_mobile_number, m.member_company_phone_number, m.member_fax_number, m.member_company_email, m.member_website_name, m.member_company_description, m.member_company_keywords, m.member_company_address1, m.member_company_address2, m.member_company_address3, m.member_company_state_id, m.member_company_city_name, m.member_company_pincode, m.member_communication_address, m.business_goals, m.accomplishments, m.interests, m.networks, m.skills, m.ideal_referral, m.top_product, m.top_problem_solved, m.sequence, m.status, bc.business_category_name,cc.club_name  from members m left join business_category bc on m.business_category_id = bc.business_category_id  left join club cc on m.club_id =cc.club_id  where m.status=? and m.member_type='RMBFB Member' order by m.member_first_name limit ?,?" and m.member_type='RMBFB Member' ;
    ...
    public List<Members> getMemberForMembersDirectoryByPage(int pagesize, int startindex) {
        ...
        List<Members> Members = new ArrayList<Members>();
        String s = "y";
    //  String sql = "select m.fellowship_id, m.member_company_name,m.member_first_name, m.member_last_name, m.member_id, m.member_profile_picture, m.member_email, m.member_mobile_number, m.member_type from members m, business_category bc where m.status=? and m.business_category_id = bc.business_category_id  order by m.member_first_name limit ?,?";
        String sql = "select   m.fellowship_id,m.member_company_name,m.member_first_name, m.member_last_name, m.member_id, m.member_profile_picture, m.member_email, m.member_mobile_number, m.member_type, bc.business_category_name from members m, business_category bc where m.status=? and m.business_category_id = bc.business_category_id  order by m.member_first_name limit ?,?";
        /* and m.member_type='RMBFB Member' */
        Connection conn = null;
        try {
            conn = dataSource.getConnection();
            PreparedStatement ps = conn.prepareStatement(sql);
            ...
            while (rs.next()) {
                members = new Members(rs.getString("member_first_name"), rs.getString("member_last_name"),
                        rs.getInt("member_id"), rs.getString("member_profile_picture"), rs.getString("member_email"),
                        rs.getString("member_mobile_number"), rs.getString("business_category_name"),rs.getString("member_type"),rs.getString("member_company_name"),rs.getInt("fellowship_id"));
                Members.add(members);
            }
            rs.close();
            ps.close();
    ...
    public void editMemberDetail1(Members member) {
      ...
      String sql = "update members set membership_number=?, club_id=?, member_category_id=?, member_type_id=?, member_type=?, business_category_id=?, tenure_plan=?, joining_date = STR_TO_DATE(?,'%d/%m/%Y'), member_name_title=?, member_first_name=?, member_middle_name=?, member_last_name=?, member_date_of_birth=STR_TO_DATE(?,'%d/%m/%Y'), member_anniversary_date=STR_TO_DATE(?,'%d/%m/%Y'), member_blood_group=?, member_aadhar_number=?, member_country_id_citizenship=?, member_passport_number=?, member_pan_number=?, member_profile_picture=?, member_email=?, member_barcode=?, member_qrcode=?, sequence=?, vocation_id=?, ip_address=?,fellowship_id=? where member_id=?";
      try {
          conn = dataSource.getConnection();
          ...
          ps.setString(13, member.getMemberDateOfBirth());
          ps.setString(14, member.getMemberAnniversaryDate());
          ps.setString(15, member.getMemberBloodGroup());
          ps.setString(16, member.getMemberAadharNumber());
          ps.setInt(17, member.getMemberCountryIdCitizenship());
          ps.setString(18, member.getMemberPassportNumber());
          ps.setString(19, member.getMemberPanNumber());
          ps.setString(20, member.getMemberProfilePicture());
          ps.setString(21, member.getMemberEmail());
          ps.setString(22, member.getMemberBarcode());
          ps.setString(23, member.getMemberQrcode());
          ps.setInt(24, member.getSequence());
          ps.setInt(25, member.getVocationId());
          ps.setString(26, member.getIpAddress());
          ps.setInt(27, member.getFellowship_id());
          System.out.println("///////////////////////DaoImpl/////////////"+member.getFellowship_id());
          ps.setInt(28, member.getMemberId());
        
  
          ps.executeUpdate();
          System.out.println("///////////////////////DaoImpl/////////////"+ps);
    ...
    public List<Members> searchMembersForMembersDirectory(String keyword) {
        ...
        List<Members> Members = new ArrayList<Members>();
        String s = "y";
        String sql = "select m.fellowship_id, m.member_first_name, m.member_last_name, m.member_id, m.member_profile_picture, m.member_email, m.member_mobile_number, m.member_type, bc.business_category_name from members m, business_category bc where m.status=? and m.business_category_id = bc.business_category_id  and concat(m.member_first_name, '', m.member_last_name, '', m.member_email, '', m.membership_number, '', bc.business_category_name, '',m.member_company_keywords) like ? order by m.member_first_name";
        Connection conn = null;
        /* and m.member_type = 'RMBFB Member' */
        try {
            conn = dataSource.getConnection();
            ...
            while (rs.next()) {
                members = new Members(rs.getString("member_first_name"), rs.getString("member_last_name"),
                        rs.getInt("member_id"), rs.getString("member_profile_picture"), rs.getString("member_email"),
                        rs.getString("member_mobile_number"), rs.getString("business_category_name"),rs.getString("member_type"),rs.getInt("fellowship_id"));
                Members.add(members);
            }
            rs.close();
            ps.close();
    ...
    public List<Members> getChapterSummaryByDate(String fromdate, String todate,int fellowship_id) {
        ...
        /*
         * String
         * sql="select q1.member_id, q1.member_first_name, q1.member_middle_name, q1.member_last_name,\n"
         * +
         * " q1.reference_given_inside, q2.reference_given_outside, q3.reference_received_inside, \n"
         * +
         * " q4.reference_received_outside, q5.member_meeting_count, q6.member_business_transaction_count from\n"
         * +
         * " (select m.member_id, m.member_first_name, m.member_middle_name, m.member_last_name, count(mr.member_referral_id)\n"
         * +
         * " as reference_given_inside from members m left join member_referral mr on m.member_id = mr.created_by \n"
         * +
         * " and m.fellowship_id=? and mr.referral_type='Inside' and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') \n"
         * +
         * " group by m.member_id) as q1,(select m.member_id, m.member_first_name, m.member_last_name, count(mr.member_referral_id)\n"
         * +
         * " as reference_given_outside from members m left join member_referral mr on m.member_id = mr.created_by and mr.referral_type='Outside' \n"
         * +
         * " and m.fellowship_id=? and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q2,\n"
         * +
         * " (select m.member_id, m.member_first_name, m.member_last_name, count(mr.member_referral_id) as reference_received_inside\n"
         * +
         * " from members m left join member_referral mr on m.member_id = mr.to_member_id and mr.referral_type='Inside' \n"
         * +
         * " and m.fellowship_id=? and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q3,\n"
         * +
         * " (select m.member_id, m.member_first_name, m.member_last_name, count(mr.member_referral_id) as reference_received_outside \n"
         * +
         * " from members m left join member_referral mr on m.member_id = mr.to_member_id and mr.referral_type='Outside'\n"
         * +
         * " and m.fellowship_id=? and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q4,\n"
         * +
         * " (select m.member_id, m.member_first_name, m.member_last_name, count(o.one_to_one_id) as member_meeting_count \n"
         * +
         * " from members m left join member_one_to_one o on m.member_id = o.created_by and m.fellowship_id=? and o.meeting_date between\n"
         * +
         * " STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q5,\n"
         * +
         * " (select m.member_id, m.member_first_name, m.member_last_name, IFNULL(sum(t.amount), 0) as member_business_transaction_count\n"
         * +
         * " from members m left join member_thank_you_slip t on m.member_id = t.to_member_id and m.fellowship_id=? and t.slip_date between STR_TO_DATE(?,'%d/%m/%Y')\n"
         * +
         * " and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q6 where q1.member_id = q2.member_id and q1.member_id = q3.member_id\n"
         * +
         * " and q1.member_id = q4.member_id and q1.member_id = q5.member_id and q1.member_id = q6.member_id order by q1.member_first_name"
         * ;
         */
        
        String sql = "select q1.member_id, q1.fellowship_id, q1.member_first_name, q1.member_middle_name, q1.member_last_name, q1.reference_given_inside, q2.reference_given_outside, q3.reference_received_inside,  q4.reference_received_outside, q5.member_meeting_count, q6.member_business_transaction_count from (select m.member_id, m.fellowship_id, m.member_first_name, m.member_middle_name, m.member_last_name, count(mr.member_referral_id) as reference_given_inside from members m left join member_referral mr on m.member_id = mr.created_by and mr.referral_type='Inside' and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y')  group by m.member_id) as q1, (select m.member_id, m.fellowship_id, m.member_first_name, m.member_last_name, count(mr.member_referral_id) as reference_given_outside from members m left join member_referral mr on m.member_id = mr.created_by and mr.referral_type='Outside' and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q2,(select m.member_id, m.fellowship_id, m.member_first_name, m.member_last_name, count(mr.member_referral_id) as reference_received_inside from members m left join member_referral mr on m.member_id = mr.to_member_id and mr.referral_type='Inside' and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q3,(select m.member_id, m.fellowship_id, m.member_first_name, m.member_last_name, count(mr.member_referral_id) as reference_received_outside from members m left join member_referral mr on m.member_id = mr.to_member_id and mr.referral_type='Outside' and mr.refer_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q4, (select m.member_id, m.fellowship_id, m.member_first_name, m.member_last_name, count(o.one_to_one_id) as member_meeting_count from members m left join member_one_to_one o on m.member_id = o.created_by and o.meeting_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q5, (select m.member_id, m.member_first_name, m.member_last_name, IFNULL(sum(t.amount), 0) as member_business_transaction_count from members m left join member_thank_you_slip t on m.member_id = t.to_member_id and t.slip_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') group by m.member_id) as q6 where q1.member_id = q2.member_id and q1.member_id = q3.member_id and q1.member_id = q4.member_id and q1.member_id = q5.member_id and q1.member_id = q6.member_id and q1.fellowship_id = ? order by q1.member_first_name";
        Connection conn = null;
        /* and member_type='RMBFB Member' */
        try {
            conn = dataSource.getConnection();
            PreparedStatement ps = conn.prepareStatement(sql);
            ...
            //ps.setInt(4, fellowship_id);
            ps.setString(3, fromdate);
            ps.setString(4, todate);
            //ps.setInt(7, fellowship_id);
            ps.setString(5, fromdate);
            ps.setString(6, todate);
            //ps.setInt(10, fellowship_id);
            ps.setString(7, fromdate);
            ps.setString(8, todate);
            //ps.setInt(13, fellowship_id);
            ps.setString(9, fromdate);
            ps.setString(10, todate);
            //ps.setInt(16, fellowship_id);
    ...
    public List<Members> getAllMembersPics() {
        ...
        List<Members> Members = new ArrayList<Members>();
        String s = "y";
        String sql = "select member_id, member_first_name, member_middle_name, member_last_name, member_profile_picture from members where status=? and member_profile_picture!=''  order by member_id";
        /* and member_type='RMBFB Member' */
        Connection conn = null;
        try {
            conn = dataSource.getConnection();
  ...
  @Override
  public String getFellowshipName(int fellowship_id) {
    logger.info("***** GET MEMBER DETAIL BY MEMBER ID *****");
    String result = "";
    String s = "y";
    String sql = "select fellowship_name from fellowship where fellowship_id=?";
    Connection conn = null;
    try {
        conn = dataSource.getConnection();
        PreparedStatement ps = conn.prepareStatement(sql);
        ...
        if (rs.next()) {
          ...
          result = rs.getString("fellowship_name");
            }
        rs.close();
        ps.close();
        return result;
  ...
  @Override
  public void resetPassword(String email, String saltString, String newpassword) {
        logger.info("+++++ RESET PASSWORD IMPL +++++");
        String sql = "update members set member_password=?, reset_flag=? where member_email=? and status=? and reset_flag=?";
        String s = "y";
        Connection conn = null;
        try {
            conn = dataSource.getConnection();
  ...
  @Override
  public String  saltstring(String e, String salt){
       logger.info("***** SET member Salt DAO Impl***** "+salt);
          String sql = "UPDATE members set reset_flag=? where member_email=? and status=?";
          ...
          finally
          {
              if (conn != null)
              {
                  try
                  {
                      ...
                      {
                          System.out.println("ERROR WHILE CLOSING==========="+e1);
                      }
              }
          }
  ...
  @Override
  public Members getsaltstring(String e, String salt) {
      logger.info("+++++ get SALTED USER +++++");
      
      Members m = null;
      
      //String sql = "select user_id, first_name, last_name, phone,mobile, email, userTypeId, reset_flag from user where status=? and email=? and reset_flag=?";

      String sql = "select member_first_name, member_last_name, member_id, member_profile_picture, member_email, member_mobile_number,member_type ,reset_flag from members where member_email=? and reset_flag=?";
      ...
      try {
          ...
          while (rs.next()) {
              ...
              m.setFirstName(rs.getString("member_first_name"));
              m.setLastName(rs.getString("member_last_name"));
              m.setMemberId(rs.getInt("member_id"));
              m.setMemberEmail(rs.getString("member_email"));
              m.setResetflag(rs.getString("reset_flag"));
          }
          rs.close();
          ps.close();
          return m;
