...
public class PaymentDAOImpl implements PaymentDAO
{
	...
	public void addMembershipPaymentTransaction(PaymentDetail pd)	{
		...
		try {
			...
			ps.setFloat(5, pd.getPaid_amount());
	...
	public void addMembershipPaymentTransaction1(PaymentDetail pd)	{
		logger.info("++++++++++ ADD MEMBERSHIP PAYMENT TRANSACTION IMPL ++++++++++");		
		String sql = "insert into payment_detail(transaction_for_id, rotary_year_id, member_id, member_category_id, paid_amount, currency_id, payment_status, status, created_by, ip_address,payment_number,sequence,rmbdfees,rmbfees) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";		
		...
		try {
			...
			ps.setInt(9, pd.getCreatedBy());
			ps.setString(10, pd.getIpAddress());	
			ps.setString(11, pd.getPaymentNumber());
			ps.setInt(12, pd.getSequence());
			ps.setFloat(13, pd.getRmbdfees());
			ps.setFloat(14, pd.getRmbfees());
	...
	public void addMembershipTransaction(PaymentDetail pd)	{
		logger.info("++++++++++ ADD transaction_fees  MEMBERSHIP PAYMENT TRANSACTION IMPL ++++++++++");		
		String sql = "insert into transaction_fees( rotary_year_id, member_id,  paid_amount, currency_id, payment_status, status, created_by, ip_address,transaction_number,sequence,rmbdfees,rmbfees) values (?,?,?,?,?,?,?,?,?,?,?,?)";		
		...
		try {
			...
			//ps.setInt(1, pd.getTransactionForId());
			ps.setInt(1, pd.getRotaryYearId());
			ps.setInt(2, pd.getMemberId());

			ps.setFloat(3, pd.getPaid_amount());
			ps.setInt(4, pd.getCurrencyId());
			ps.setString(5, pd.getPaymentStatus());						
			ps.setString(6, pd.getStatus());
			ps.setInt(7, pd.getCreatedBy());
			ps.setString(8, pd.getIpAddress());	
			ps.setString(9, pd.getPaymentNumber());
			ps.setInt(10, pd.getSequence());
			ps.setFloat(11, pd.getRmbdfees());
			ps.setFloat(12, pd.getRmbfees());
			ps.executeUpdate();					
		} catch (SQLException e1) {
			throw new RuntimeException(e1);
        } finally {
	...
	//	String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.payment_status = 'Unpaid'  and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id order by payment_detail_id desc limit ?,?";
		Connection conn = null;
	...
	public List<PaymentDetail> getAllPendingPayments() {
		...
		String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.payment_status = 'Unpaid' and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id order by payment_detail_id desc";
	...
	//	String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.payment_status = 'Unpaid' and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id and Concat(m.member_first_name,'', m.member_middle_name,'', m.member_last_name) like ?";
		String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.payment_status = 'Unpaid'  and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id and Concat(m.member_first_name,'', m.member_middle_name,'', m.member_last_name) like ?";
		Connection conn = null;		
		try {
			conn = dataSource.getConnection();
			PreparedStatement ps = conn.prepareStatement(sql);			
	...
	//	String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.member_id = ? and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id";
		String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.member_id = ?  and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id";
		Connection conn = null;
		try {
			conn = dataSource.getConnection();
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public void addPaymentInfo(PaymentDetail pd)	{
		...
		String sql = "update payment_detail set payment_status=?, payment_method=?, bank_name=?, branch_name=?, cheque_no=?, paid_amount=?, transaction_date = STR_TO_DATE(?,'%d/%m/%Y'), created_by=?, ip_address=? where payment_detail_id=?";
		...
		//	ps.setString(2, pd.getPaymentNumber());
			ps.setString(1, pd.getPaymentStatus());
			ps.setString(2, pd.getPaymentMethod());
			ps.setString(3, pd.getBankName());
			ps.setString(4, pd.getBranchName());
			ps.setString(5, pd.getChequeNo());
			ps.setFloat(6, pd.getPaidAmount());
			ps.setString(7, pd.getTransactionDate());
			ps.setInt(8, pd.getCreatedBy());			
			ps.setString(9, pd.getIpAddress());
			ps.setInt(10, pd.getMemberId());
			
			System.out.println("-------getPaymentNumber----------"+pd.getPaymentNumber());
			System.out.println("-------getPaymentStatus----------"+pd.getPaymentStatus());
			System.out.println("-------getPaidAmount----------"+pd.getPaidAmount());
			System.out.println("-------getMemberId----------"+pd.getMemberId());
			ps.executeUpdate();					
		} catch (SQLException e1) {
			throw new RuntimeException(e1);
        } finally {
	...
	public void UpdateTransaction(PaymentDetail pd)	{
		logger.info("++++++++++UpdateTransaction IMPL ++++++++++");		
		//String sql = "update payment_detail set sequence=?, payment_number=?, payment_status=?, payment_method=?, bank_name=?, branch_name=?, cheque_no=?, paid_amount=?, transaction_date = STR_TO_DATE(?,'%d/%m/%Y'), created_by=?, ip_address=? where payment_detail_id=?";		
		String sql = "update transaction_fees set payment_status=?, paid_amount=?, created_by=?, ip_address=? where transaction_id=?";
		...
		//	ps.setString(4, pd.getBranchName());
		//	ps.setString(5, pd.getChequeNo());
			ps.setFloat(2, pd.getPaidAmount());
		//	ps.setString(7, pd.getTransactionDate());
			ps.setInt(3, pd.getCreatedBy());			
			ps.setString(4, pd.getIpAddress());
			ps.setInt(5, pd.getMemberId());
	...
	public List<PaymentDetail> getPaymentHistoryByPage(int rotaryyearid, int pagesize, int startindex) {
		logger.info("++++++++++ GET PAYMENT HISTORY BY PAGE IMPL 0 +++++++++++");		
		List<PaymentDetail> PaymentDetail = new ArrayList<PaymentDetail>();		
	//String sql = "select m.user_role_id,ff.fellowship_name as fellowship_name,m.fellowship_id as fellowship_id, pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c, fellowship ff where pd.status = 'y' and pd.payment_status = 'Paid' and pd.rotary_year_id=? and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id  and ff.fellowship_id=m.fellowship_id order by payment_detail_id desc limit ?,?";
//LAST oNE	String sql = "select m.user_role_id,ff.fellowship_name as fellowship_name,m.fellowship_id as fellowship_id, pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c, fellowship ff where pd.status = 'y' and pd.rotary_year_id=? and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id  and ff.fellowship_id=m.fellowship_id order by payment_detail_id desc limit ?,?";
	
	String sql = "select m.user_role_id,ff.fellowship_name as fellowship_name,m.fellowship_id as fellowship_id, pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c, fellowship ff where pd.status = 'y' and pd.rotary_year_id=? and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id   and ff.fellowship_id=m.fellowship_id order by payment_detail_id desc limit ?,?";
	
	
	//OLD	String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.payment_status = 'Paid' and pd.rotary_year_id=?  and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id order by payment_detail_id desc limit ?,?";
	...
	public List<PaymentDetail> getPaymentHistoryByPage1(int rotaryyearid, int pagesize, int startindex,int fellowship_id) {
		logger.info("++++++++++ GET PAYMENT HISTORY BY PAGE IMPL 1 +++++++++++");		
		List<PaymentDetail> PaymentDetail = new ArrayList<PaymentDetail>();		
		System.out.println("DAO-rotaryyearid:-"+rotaryyearid);
		System.out.println("DAO-startindex:-"+startindex);
		System.out.println("DAO-pagesize:-"+pagesize);
		System.out.println("DAO-fellowship_id:-"+fellowship_id);
	String sql = "select m.user_role_id,ff.fellowship_name as fellowship_name,m.fellowship_id as fellowship_id, pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c, fellowship ff where pd.status = 'y' and pd.rotary_year_id=? and m.fellowship_id=? and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id   and ff.fellowship_id=m.fellowship_id order by payment_detail_id desc limit ?,?";
	...
	public List<PaymentDetail> getAllPaymentHistory(int rotaryyearid) {
		...
		List<PaymentDetail> PaymentDetail = new ArrayList<PaymentDetail>();		
		//String sql = "select  m.user_role_id,ff.fellowship_name,m.fellowship_id,pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c, fellowship ff  where pd.status = 'y' and pd.payment_status = 'Paid' and pd.rotary_year_id=? and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id and ff.fellowship_id=m.fellowship_id order by payment_detail_id desc";		
		String sql = "select  m.user_role_id,ff.fellowship_name,m.fellowship_id,pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c, fellowship ff  where pd.status = 'y' and pd.rotary_year_id=? and t.transaction_for_id = pd.transaction_for_id and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id and ff.fellowship_id=m.fellowship_id order by payment_detail_id desc";
	
		
		// OLD String sql = "select pd.payment_detail_id, pd.transaction_for_id, pd.rotary_year_id, pd.member_id, pd.member_category_id, pd.payment_amount, pd.currency_id, pd.payment_status, pd.payment_method, pd.bank_name, pd.branch_name, pd.cheque_no, pd.paid_amount, DATE_FORMAT(pd.transaction_date,'%d/%m/%Y') as transaction_date, t.transaction_for_name, ry.rotary_year_title, mc.member_category_name, m.member_name_title, m.member_first_name, m.member_middle_name, m.member_last_name, c.currency_code from payment_detail pd, transaction_for t, members m, rotary_year ry, member_category mc, currency c where pd.status = 'y' and pd.payment_status = 'Paid' and pd.rotary_year_id=?  and ry.rotary_year_id = pd.rotary_year_id and mc.member_category_id = pd.member_category_id and m.member_id = pd.member_id and c.currency_id = pd.currency_id order by payment_detail_id desc";
		Connection conn = null;		
		try {
			conn = dataSource.getConnection();
			PreparedStatement ps = conn.prepareStatement(sql);
