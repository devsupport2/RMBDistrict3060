...
public class LoginDAOImpl implements LoginDAO {
	...
	public Members frontLogin(String userName, String password) {
		...
		String sql = "select member_id,fellowship_id, membership_number, member_first_name, member_last_name, member_profile_picture, member_email, member_password, member_mobile_number, status, member_type,company_logo from members where status!='n' and (member_email = ? OR member_mobile_number = ?) AND member_password = ?";
		...
		try {
			...
			if (rs.next()) {
				...
				members.setCompanyLogo(rs.getString("company_logo"));
			}
			rs.close();
			ps.close();
			return members;
	...
	public Members checkLogin(String member_email, String member_password) {
		...
		try {
			...
			if (rs.next()) {
				...
				user.setMemberEmail(rs.getString("user_name"));
