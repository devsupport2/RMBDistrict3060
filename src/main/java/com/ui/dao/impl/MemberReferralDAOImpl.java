...
public class MemberReferralDAOImpl implements MemberReferralDAO {
	...
	public List<MemberOneToOne> getMemberMeetingsByIdRec(int memberid, String fromdate, String todate) {
		logger.info("+++++ GET MEMBER MEETING BY ID REc +++++");
		List<MemberOneToOne> MemberOneToOne = new ArrayList<MemberOneToOne>();
		String s = "y";
		String sql = "select o.one_to_one_id, o.met_member_id, m.member_first_name, m.member_middle_name, m.member_last_name, o.invited_by_member_id, mm.member_first_name as invitee_first_name, mm.member_middle_name as invitee_middle_name, mm.member_last_name as invitee_last_name, DATE_FORMAT(o.meeting_date, '%d/%m/%Y') as meeting_date, o.location, o.conversation_topic from member_one_to_one o, members m, members mm where o.status=? and o.met_member_id=? and o.meeting_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') and m.member_id = o.met_member_id and mm.member_id = o.invited_by_member_id order by o.meeting_date";
		Connection conn = null;
		/* and mm.member_id = o.invited_by_member_id */
		try {
			conn = dataSource.getConnection();
	...
	public List<MemberThankYouSlip> getMemberBusinessById(int memberid, String fromdate, String todate) {
		...
		String s = "y";
		String sql = "select t.thank_you_slip_id, t.to_member_id, m.member_first_name, m.member_middle_name, m.member_last_name, t.amount, DATE_FORMAT(t.slip_date, '%d/%m/%Y') as slip_date, t.business_type, t.referral_type, t.comments from member_thank_you_slip t, members m where t.status=? and t.to_member_id=? and t.slip_date between STR_TO_DATE(?,'%d/%m/%Y') and STR_TO_DATE(?,'%d/%m/%Y') and m.member_id = t.created_by order by t.slip_date";
		Connection conn = null;
		try {
			conn = dataSource.getConnection();
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public List<MemberThankYouSlip> getMemberBusinessByIdRec(int memberid, String fromdate, String todate) {
		logger.info("+++++/////////////////////// GET MEMBER BUSINESS BY ID  Recieved /////////////////////////+++++");
		List<MemberThankYouSlip> MemberThankYouSlip = new ArrayList<MemberThankYouSlip>();
		String s = "y";
    ...
    //  String sql = "select t.thank_you_slip_id, t.to_member_id, m.member_first_name as to_first_name, m.member_middle_name as to_middle_name, m.member_last_name as to_last_name, f.member_first_name as from_first_name, f.member_last_name as from_last_name, t.amount, DATE_FORMAT(t.slip_date, '%d/%m/%Y') as slip_date, t.business_type, t.referral_type, t.comments, t.created_by from member_thank_you_slip t, members m , members f where t.status=? and t.slip_date and m.member_id = t.to_member_id and f.member_id = t.created_by order by t.slip_date desc";
      String sql="select m.fellowship_id,ff.fellowship_name,t.thank_you_slip_id, t.to_member_id, m.member_first_name as to_first_name, m.member_middle_name as to_middle_name, m.member_last_name as to_last_name,f.member_first_name as from_first_name, f.member_last_name as from_last_name, t.amount,DATE_FORMAT(t.slip_date, '%d/%m/%Y') as slip_date, t.business_type, t.referral_type ,t.comments, t.created_by from member_thank_you_slip t, members m , members f,fellowship ff where t.status=? and t.slip_date and m.member_id = t.to_member_id and ff.fellowship_id = m.fellowship_id and f.member_id = t.created_by order by t.slip_date desc";
      Connection conn = null;
      try {
          conn = dataSource.getConnection();
          PreparedStatement ps = conn.prepareStatement(sql);
          ...
          while (rs.next()) {
              memberThankYouSlip = new MemberThankYouSlip(rs.getInt("fellowship_id"),  rs.getString("fellowship_name"),rs.getInt("thank_you_slip_id"), rs.getInt("to_member_id"),
	...
	public List<MemberOneToOne> getAllMeeting() {
     ...
     // String sql = "select o.one_to_one_id, o.met_member_id, m.member_first_name, m.member_middle_name, m.member_last_name, o.invited_by_member_id, mm.member_first_name as invitee_first_name, mm.member_middle_name as invitee_middle_name, mm.member_last_name as invitee_last_name, DATE_FORMAT(o.meeting_date, '%d/%m/%Y') as meeting_date, o.location, o.conversation_topic from member_one_to_one o, members m, members mm where o.status=? and o.meeting_date and m.member_id = o.met_member_id and mm.member_id = o.invited_by_member_id order by o.meeting_date desc";
      String sql = "select  ff.fellowship_name,mm.fellowship_id,o.one_to_one_id, o.met_member_id, m.member_first_name, m.member_middle_name,m.member_last_name, o.invited_by_member_id, mm.member_first_name as invitee_first_name,mm.member_middle_name as invitee_middle_name, mm.member_last_name as invitee_last_name, DATE_FORMAT(o.meeting_date, '%d/%m/%Y') as meeting_date, o.location, o.conversation_topic from member_one_to_one o, members m, members mm, fellowship ff  where o.status=? and o.meeting_date  and m.member_id = o.met_member_id and ff.fellowship_id = mm.fellowship_id and mm.member_id = o.invited_by_member_id order by o.meeting_date desc";
      Connection conn = null;
      try {
          conn = dataSource.getConnection();
          PreparedStatement ps = conn.prepareStatement(sql);
          ...
          while (rs.next()) {
              ...
              memberOneToOne = new MemberOneToOne();
				...
				memberOneToOne.setLocation(rs.getString("location"));
				memberOneToOne.setConversationTopic(rs.getString("conversation_topic"));
				memberOneToOne.setFellowship_id(rs.getInt("fellowship_id"));
				memberOneToOne.setFellowship_name(rs.getString("fellowship_name"));
	...
	public List<MemberReferral> getAllReference() {
      ...
      List<MemberReferral> MemberReferral = new ArrayList<MemberReferral>();
      String s = "y";
      String sql = "select ff.fellowship_name, mm.fellowship_id, r.member_referral_id, r.to_member_id, m.member_first_name, m.member_middle_name, m.member_last_name, r.referral_name, mm.member_first_name as from_first_name, mm.member_middle_name as from_middle_name, mm.member_last_name as from_last_name, DATE_FORMAT(r.refer_date, '%d/%m/%Y') as refer_date, r.referral_type, r.referral_status1, r.referral_status2, r.address, r.contact_number, r.email, r.comments from member_referral r, members m, members mm , fellowship ff where r.status=?  and ff.fellowship_id = mm.fellowship_id and m.member_id = r.to_member_id and mm.member_id = r.created_by order by r.refer_date desc";
      Connection conn = null;
      try {
          conn = dataSource.getConnection();
          PreparedStatement ps = conn.prepareStatement(sql);
          ...
          while (rs.next()) {
              memberReferral = new MemberReferral(rs.getInt("fellowship_id"),rs.getString("fellowship_name"),rs.getInt("member_referral_id"), rs.getInt("to_member_id"),
                      rs.getString("member_first_name"), rs.getString("member_middle_name"),
	...
	public void CloseRef(MemberReferral mr) {
	 ...
	 public List<MemberReferral> getAllReferenceBYFellowshipId(int fellowship_id) {
	      ...
	      List<MemberReferral> MemberReferral = new ArrayList<MemberReferral>();
	      String s = "y";
	      String sql = "select ff.fellowship_name,mm.fellowship_id,r.member_referral_id, r.to_member_id, m.member_first_name, m.member_middle_name, m.member_last_name, r.referral_name, mm.member_first_name as from_first_name, mm.member_middle_name as from_middle_name, mm.member_last_name as from_last_name, DATE_FORMAT(r.refer_date, '%d/%m/%Y') as refer_date, r.referral_type, r.referral_status1, r.referral_status2, r.address, r.contact_number, r.email, r.comments from member_referral r, members m, members mm, fellowship ff where r.status=? and mm.fellowship_id=? and  m.member_id = r.to_member_id  and ff.fellowship_id = mm.fellowship_id and mm.member_id = r.created_by order by r.refer_date desc";
	      Connection conn = null;
	      try {
	          conn = dataSource.getConnection();
	          PreparedStatement ps = conn.prepareStatement(sql);
	 ...
	 public List<MemberOneToOne> getAllMeetingBYFellowshipId(int fellowship_id) {
	      ...
	      List<MemberOneToOne> MemberOneToOne = new ArrayList<MemberOneToOne>();
	      String s = "y";
	      String sql = "select ff.fellowship_name,mm.fellowship_id,o.one_to_one_id, o.met_member_id, m.member_first_name, m.member_middle_name,m.member_last_name, o.invited_by_member_id, mm.member_first_name as invitee_first_name,mm.member_middle_name as invitee_middle_name, mm.member_last_name as invitee_last_name, DATE_FORMAT(o.meeting_date, '%d/%m/%Y') as meeting_date, o.location, o.conversation_topic from member_one_to_one o, members m, members mm, fellowship ff  where o.status=?  and mm.fellowship_id=? and o.meeting_date  and m.member_id = o.met_member_id and ff.fellowship_id = mm.fellowship_id and mm.member_id = o.invited_by_member_id order by o.meeting_date desc";
	      Connection conn = null;
	      try {
	          conn = dataSource.getConnection();
	          PreparedStatement ps = conn.prepareStatement(sql);
	 ...
	 public List<MemberThankYouSlip> getAllBusinessBYFellowshipId(int fellowship_id) {
	      ...
	      String s = "y";
	    //  String sql = "select t.thank_you_slip_id, t.to_member_id, m.member_first_name as to_first_name, m.member_middle_name as to_middle_name, m.member_last_name as to_last_name, f.member_first_name as from_first_name, f.member_last_name as from_last_name, t.amount, DATE_FORMAT(t.slip_date, '%d/%m/%Y') as slip_date, t.business_type, t.referral_type, t.comments, t.created_by from member_thank_you_slip t, members m , members f where t.status=? and t.slip_date and m.member_id = t.to_member_id and f.member_id = t.created_by order by t.slip_date desc";
	      String sql="select m.fellowship_id,ff.fellowship_name,t.thank_you_slip_id, t.to_member_id, m.member_first_name as to_first_name, m.member_middle_name as to_middle_name, m.member_last_name as to_last_name,f.member_first_name as from_first_name, f.member_last_name as from_last_name, t.amount,DATE_FORMAT(t.slip_date, '%d/%m/%Y') as slip_date, t.business_type, t.referral_type ,t.comments, t.created_by from member_thank_you_slip t, members m , members f,fellowship ff where t.status=? and m.fellowship_id=?  and t.slip_date and m.member_id = t.to_member_id and ff.fellowship_id = m.fellowship_id and f.member_id = t.created_by order by t.slip_date desc";
	      Connection conn = null;
	      try {
	          conn = dataSource.getConnection();
	          PreparedStatement ps = conn.prepareStatement(sql);
		...
		public String editMeeting(MemberOneToOne memberOneToOne) {
			    ...
			    String sql = "update member_one_to_one set met_member_id=?, invited_by_member_id=?,meeting_date=STR_TO_DATE(?,'%d/%m/%Y') ,location=?,conversation_topic=?, status=?, created_by=?, ip_address=? where one_to_one_id=?";
			    Connection conn = null;
			    try {
			        conn = dataSource.getConnection();
			        PreparedStatement ps = conn.prepareStatement(sql);
			        
			        ps.setInt(1, memberOneToOne.getMetMemberId());
			        ps.setInt(2, memberOneToOne.getInvitedByMemberId());
			        ps.setString(3, memberOneToOne.getMeetingDate());
			        ps.setString(4, memberOneToOne.getLocation());
			        ps.setString(5, memberOneToOne.getConversationTopic());
			        ps.setString(6, memberOneToOne.getStatus());
			    	ps.setInt(7, memberOneToOne.getCreatedBy());
					ps.setString(8, memberOneToOne.getIpAddress());

			        ps.setInt(9, memberOneToOne.getOneToOneId());
		...
		public String editBusiness(MemberThankYouSlip m) {
			    ...
			    logger.info("+++++ EDIT Member +++++");
			    String sql = "update member_thank_you_slip set to_member_id=?, amount=?,slip_date=STR_TO_DATE(?,'%d/%m/%Y') ,business_type=?,referral_type=?,comments=?,created_by=?, status=?,ip_address=? where thank_you_slip_id=?";
			    Connection conn = null;
			    try {
			        conn = dataSource.getConnection();
			        PreparedStatement ps = conn.prepareStatement(sql);
			        
			        ps.setInt(1, m.getToMemberId());
			        ps.setFloat(2, m.getAmount());
			        ps.setString(3, m.getSlipDate());
			        ps.setString(4, m.getBusinessType());
			        ps.setString(5, m.getReferralType());
			        ps.setString(6, m.getComments());
			    	ps.setInt(7, m.getCreatedBy());
			    	  ps.setString(8, m.getStatus());
					ps.setString(9, m.getIpAddress());

			        ps.setInt(10, m.getThankYouSlipId());
