...
public class Fellowship {
	...
	private String fellowship_city;
	private String status;
	
	private AllCount allCo;
	
	
	
	
	public String getFellowship_city() {
		return fellowship_city;
	}
	public void setFellowship_city(String fellowship_city) {
		this.fellowship_city = fellowship_city;
	}
	...
	public AllCount getAllCo() {
		return allCo;
	}
	public void setAllCo(AllCount allCo) {
		this.allCo = allCo;
	}
