...
public class Members {
	...
	private String member_business_nature;
	private String member_company_description;
	private String member_company_keywords;
	private String member_website_name;
    ...
    public Members(int memberId, String memberFirstName, String memberLastName, String memberProfilePicture,String memberEmail,String memberMobileNumber,int fellowship_id, String businessCategoryName,String memberCompanyName, String member_occupation, String member_designation, String member_business_nature, String member_company_description, String member_company_keywords, String member_website_name ) {
        super();
        this.memberId = memberId;
        this.memberFirstName = memberFirstName;       
        this.memberLastName = memberLastName;
    	...
    	this.member_business_nature=member_business_nature;
    	this.member_company_description=member_company_description;
    	this.member_company_keywords=member_company_keywords;
    	this.member_website_name=member_website_name;
    }
	...
	public Members(String memberFirstName, String memberLastName, int memberId, String memberProfilePicture,
			String memberEmail, String memberMobileNumber, String businessCategoryName, String membertype ,int fellowship_id ) {
		super();
		this.memberFirstName = memberFirstName;
		this.memberLastName = memberLastName;
		this.memberId = memberId;
	...
	public Members(final String memberFirstName, final String memberMiddleName, final String memberLastName, final int memberId, final String memberProfilePicture, final String memberEmail, final String memberMobileNumber, final String businessCategoryName, final String password, final String memberDateOfBirth, final String memberCompanyKeywords) {
      this.memberFirstName = memberFirstName;
      this.memberLastName = memberLastName;
      this.memberId = memberId;
      this.memberProfilePicture = memberProfilePicture;
	...
	public Members(String memberFirstName, String memberLastName, int memberId, String memberProfilePicture,
			String memberEmail, String memberMobileNumber, String businessCategoryName, String membertype,String memberCompanyName ) {
		super();
		this.memberFirstName = memberFirstName;
		this.memberLastName = memberLastName;
		this.memberId = memberId;
	...
	public Members(String memberFirstName, String memberLastName, int memberId, String memberProfilePicture,
			String memberEmail, String memberMobileNumber, String businessCategoryName, String membertype,String memberCompanyName,int fellowship_id ) {
		super();
		this.memberFirstName = memberFirstName;
		this.memberLastName = memberLastName;
		this.memberId = memberId;
	...
	public Members(int memberId, int userTypeId, String membershipNumber, int clubId, int memberCategoryId,
			...
			String businessCategoryName,String user_role_name,int user_role_id) {
		super();
		this.memberId = memberId;
		this.userTypeId = userTypeId;
		this.membershipNumber = membershipNumber;
	...
	public Members(int memberId, int userTypeId, String membershipNumber, int clubId, int memberCategoryId,
			...
			String businessGoals, String accomplishments, String interests, String networks, String skills,
			String idealReferral, String topProduct, String topProblemSolved, int sequence, String status,
			String businessCategoryName,String clubName,String fellowship_name,int fellowship_id,String user_role_name,int user_role_id) {
		super();
		this.memberId = memberId;
		this.userTypeId = userTypeId;
		this.membershipNumber = membershipNumber;
	...
	public Members(String memberPassword,int memberId, int userTypeId, String membershipNumber,int vocation_id, int clubId, int memberCategoryId,
			int memberTypeId, int businessCategoryId, String tenurePlan, String joiningDate, String memberNameTitle,
			String memberFirstName, String memberMiddleName, String memberLastName, String memberGender,
			String memberDateOfBirth, String memberAnniversaryDate, String memberBloodGroup, String memberAadharNumber,
			int memberCountryIdCitizenship, String memberPassportNumber, String memberPanNumber,
...
public String getMember_business_nature() {
  return member_business_nature;
}

public void setMember_business_nature(String member_business_nature) {
  this.member_business_nature = member_business_nature;
}

public String getMember_company_description() {
  return member_company_description;
}

public void setMember_company_description(String member_company_description) {
  this.member_company_description = member_company_description;
}

public String getMember_company_keywords() {
  return member_company_keywords;
}

public void setMember_company_keywords(String member_company_keywords) {
  this.member_company_keywords = member_company_keywords;
}

public String getMember_website_name() {
  return member_website_name;
}

public void setMember_website_name(String member_website_name) {
  this.member_website_name = member_website_name;
}
