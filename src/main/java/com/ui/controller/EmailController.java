...
public class EmailController {
	...
	@RequestMapping(value = "sendFellowshipFess", method = RequestMethod.POST)
	public String sendFellowshipFess(int memberid, HttpSession session, HttpServletRequest request) {

		logger.info("********** sendFellowshipFess **********");
		
		Members members = memberdao.getMemberByMemberId(memberid);
		String usermessage="";
		String memberemail = members.getMemberEmail();
		String mobile_number = members.getMemberMobileNumber();
       ...
       // props.put("mail.smtp.starttls.enable", "true");
        ...
        try {
           	...
           	message.setFrom(new InternetAddress("noreply@rmbdistrict3060.in","RMB District 3060")); 
            message.setRecipients(Message.RecipientType.TO,InternetAddress.parse(memberemail));
           	...
           	message.setSubject("User message for you from RMB District 3060");
           	...
           	sb.append("<table style='border:solid 1px #bcc2cf; font-family: Arial,Helvetica,sans-serif;' align='center' width='750' cellspacing='0' cellpadding='0' border='0'><tbody><tr>"
           			...
           			+ "<table width='100%' cellspacing='0' cellpadding='0' border='0'><tbody><tr><td colspan='3' style='font-family:Arial,Helvetica,sans-serif; font-size:15px;color:#0072c6; border-bottom:solid 1px #dbdfe6' align='left' valign='top' height='25'> You Have New Message From RMB District 3060 </td>"
							/*
							 * +
							 ...
							 * +
							 * "<td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top' width='12%'><strong> Full Name: </strong></td><td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top' width='77%'> "
							 * +firstname+" "+lastname+" </td></tr><tr>" +
							 * "<td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top' width='12%'><strong> Email:</strong></td><td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top'> "
							 * +email+" </td></tr><tr>" +
							 * "<td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top' width='12%'><strong> Mobile: </strong></td><td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top'> "
							 * +mobileno+" </td></tr><tr>" +
							 * "<td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top' width='12%'><strong> Message : </strong></td><td style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737' align='left' valign='top'> "
							 * +usermessage+" </td></tr><tr>"
							 */
    ...
    public String sendUserMessage(int memberid,String firstname, String lastname, String email, String mobileno,
        ...
        {
          memberemail = memberemail+","+loggedInEmail;
        }
	...
	@RequestMapping(value={"sendEmailForForgetPassword"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
	  public String sendEmailForForgetPassword(String firstname, String lastname, String email, HttpSession session, HttpServletRequest request, HttpServletResponse res) { 
	      ...
	      final String username = "noreply@rmbdistrict3060.in";
	        ...
	        String salt=accessController.getSaltString(10);
	           
            String e=email;
            //setsaltstring in database
            memberdao.saltstring(e, salt);
            
            Members m=memberdao.getsaltstring(e, salt);
            //System.out.println("email " + m.getMemberEmail() + "--lastname---"+m.getResetflag());
            
            System.out.println("enter fiest name " + firstname + "--lastname---"+lastname +"---email="+email);
	      ...
	      try {
	        InternetAddress[] myBccList = InternetAddress.parse("webmaster@ultrainfotech.net");
	          //InternetAddress[] myBccList = InternetAddress.parse("devsupport3@ultrainfotech.net");
	          Message message = new MimeMessage(session1);
	         message.setFrom(new InternetAddress("noreply@rmbdistrict3060.in", "RMB District 3060"));
	          //message.setFrom(new InternetAddress("devsupport3@ultrainfotech.net", "RMB District 3060"));
	          message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(email));
	          message.setRecipients(Message.RecipientType.BCC, myBccList);            
	          message.setSubject("RMB District 3060 - Password Recovery");
	          StringBuilder sb = new StringBuilder();
	          sb.append("<br><h3> \n Dear "+firstname+" "+lastname+",</h3>");
	          sb.append("<br/><h2> Please visit this link to reset your password:<a href='http://www.rmbdistrict3060.in/reset_password/"+m.getResetflag()+"?email="+ m.getMemberEmail()+"'>Click here...</a></h2>");
	          sb.append("<br/><h2> For Any Queries, you may contact us<br/><br/></h2>");
	          sb.append("<br/><br/><h2> With Regards,</h2>");
	          sb.append("<h2> RMB District 3060</h2>");
	          message.setContent(sb.toString(), "text/html");          
	          Transport.send(message);          
	          System.out.println("E-Mail Send Suceessfully For Delivery...Using JSP.........");
	        } catch (Exception msg) {
 ...
 //generate salt string
    ...
    public String joinRmbf(String firstname, String lastname, String mobilenumber, String email, String rotarian, String description, HttpSession session, HttpServletRequest request, HttpServletResponse res) { 
        logger.info("********** INSIDE SEND EMAIL FOR JOIN RMBF  **********");
        ...
        try {
            ...
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(email));
            message.setRecipients(Message.RecipientType.BCC, myBccList);            
            message.setSubject("RMB District 3060 - Join RMB District 3060");
            StringBuilder sb = new StringBuilder();
            sb.append(
                  "<table style='border:solid 1px #fec736; font-family: Arial,Helvetica,sans-serif;' align='center' width='750' cellspacing='0' cellpadding='0' border='0'>"
                          + "<tbody><tr><td style='padding:15px 0px;  font-size: 14px;  color: #373737; ' align='center' valign='middle'> <a href='http://www.rmbdistrict3060.in/'> <img border='0' src=''/></a></td></tr><tr><td style='line-height:0;font-size:0;vertical-align:top;padding:0px;text-align:left;border-bottom:4px solid #005DAA'></td>"
                          ...
                          + firstname + " " + lastname+ ","
                          + "</strong></p><br>"
                          + "Thank you for showing interest in joining RMB District 3060!.One of our members will be in touch with you soon.<br>"
    ...
    public String sendOrderConfirmationMail(String ordernumber, HttpSession session, HttpServletRequest request,
        ...
        try {
            ...
            message.setRecipients(Message.RecipientType.BCC, myBccList);
            message.setSubject("Payment Confirmation- RMB District 3060");
            StringBuilder sb = new StringBuilder();
            sb.append(
                    "<table style='border:solid 1px #bcc2cf; font-family: Arial,Helvetica,sans-serif;' align='center' width='750' cellspacing='0' cellpadding='0' border='0'>"
                            + "<tbody>"
                            + "<tr><td style='padding:15px 0px;  font-size: 16px;  color: #373737; background-color: #f7f7f7;' align='center' valign='middle'><a href='http://rmbdistrict3060.in'> "
                            ...
                            + "With warm regards and best of wishes,<br>" + "<strong> RMB District 3060"
	        ...
	        if(emailCheck) {
	        	for(Members m : members)
	        	{
			        try {
			            ...
			            message.setRecipients(Message.RecipientType.BCC, myBccList);
			            message.setSubject("Communication from RMB District 3060");
			            StringBuilder sb = new StringBuilder();
			            sb.append(
			                    "<table style='border:solid 1px #bcc2cf; font-family: Arial,Helvetica,sans-serif;' align='center' width='750' cellspacing='0' cellpadding='0' border='0'>"
			                            + "<tbody>"
			                            ...
			                            + Content + "<br><br>"
			                            + "With warm regards and best of wishes,<br>" + "<strong> rmbdistrict3060.in"
			                            + "</strong><br></td></tr></tbody></table></td></tr></tbody>"
			                            + "</table></td></tr></tbody></table>");
