...
/*	@RequestMapping(value = "resetPassword", method = RequestMethod.POST)
    public String resetPassword(String email, String newpassword, HttpServletRequest request, HttpSession session) {
	   ...
	   @RequestMapping(value = "resetPassword", method = RequestMethod.POST)
	    public String resetPassword(String newpassword, HttpServletRequest request, HttpSession session) {
	        logger.info("********** INSIDE RESET PASSWORD CONTROLLER **********");
	     
	        
	           String saltString = session.getAttribute("forgotPassSalt").toString();
	           String email = session.getAttribute("forgotPassEmail").toString();
	        
	        
	           memberdao.resetPassword(email,saltString,newpassword);
...
/*	@RequestMapping(value = "/getMemberByPage", method = RequestMethod.GET, produces = "application/json")
	...
	*/
	...
	public String sendNotificationToMembers(HttpSession session, HttpServletRequest request, HttpServletResponse res) {
		...
		for (int i = 0; i < members.size(); i++) {
			...
			if (notifyviaemail.equals("Yes")) {
				...
				final String username = "emailrelay@rmbfmadurai.com";
			    final String password = "rEL@y63m@!L";
			    
		        Properties props = new Properties();
		        props.put("mail.smtp.auth", "true");        
		        props.put("mail.smtp.host", "mail.rmbfmadurai.com");
				...
				try {
					...
					message.setFrom(new InternetAddress(username, "RMBFD"));
					...
					sb.append(
							"<table style='border:solid 1px #fec736; font-family: Arial,Helvetica,sans-serif;' align='center' width='750' cellspacing='0' cellpadding='0' border='0'>"
									+ "<tbody><tr><td style='padding:15px 0px;  font-size: 14px;  color: #373737; ' align='center' valign='middle'> <a href='http://www.rmbfmadurai.com/'> <img border='0' src=''/></a></td></tr><tr><td style='line-height:0;font-size:0;vertical-align:top;padding:0px;text-align:left;border-bottom:4px solid #005DAA'></td>"
			...
			if (notifyviasms.equals("Yes")) {
				...
				try {
					...
					String urlParameters = "mobile=9845326217&pass=Superrmb#1&senderid=RMBBLR&to="
							+ memberMobileNumber
							+ "&msg=This is RMBFD Event Notificaton, Please visit RMBFD Official Website for more details, Thank you.";
	...
	public String addmemberdetail(@RequestParam(value = "profile", required = false) MultipartFile profile,
		...
		if(FirstCH.equals("RMBFD")) {memberType="RMBFD Member"; System.out.println("Firstch2 = "+ FirstCH);}
    ...
    public String addContactDetail(@RequestParam(value = "companylogo", required = false) MultipartFile companylogo,
            String address1, String address2, String address3, int statename, String cityname, String pincode,String mobilenumber,
        ...
        try {
            if (companylogo.getOriginalFilename() != "") {
                try {
                    ...
                    members.setMemberMobileNumber(mobilenumber);
	...
	public String editmemberdetail1(@RequestParam(value = "profile", required = false) MultipartFile profile,
			int rotaryyearid, int memberid, String membershipid, int memberclubname, String membercategoryname,
			...
			int valueh,int fellowship_id,String password, HttpSession session, HttpServletRequest request) throws IOException {
		...
		try {
			if (profile.getOriginalFilename() != null && profile.getOriginalFilename() != "") {
				try {
					...
					memberCategoryByYear = new MemberCategoryByYear(rotaryyearid);
					memberdao.addMemberCategoryByRotaryYear(memberCategoryByYear);
					...
					members.setMembershipNumber(membershipid);
					members.setClubId(memberclubname);
					members.setMemberCategoryName(membercategoryname);
					members.setMemberTypeId(membertypename);
					members.setMemberType(memberType);
					members.setBusinessCategoryId(businesscategoryid);
					members.setTenurePlan(tenureplan);
	...
	@RequestMapping(value = "/editContactDetailMobile", method =  {RequestMethod.POST,RequestMethod.GET})
    ...
    public String editProfilePicture1(@RequestParam(value = "profilepicture", required = false) MultipartFile profilepicture,
            int memberid, String profileimage, int valuex, int valuey, int valuew, int valueh,
           	String firstname, String middlename, String lastname, String mobile, String email, String dateofbirth, String password,  int businesscategoryid,String businesskeywords,
        ...
        try {
            ...
            members.setMemberId(memberid);
            members.setMemberProfilePicture(memberprofileimage);
            members.setIpAddress(ipAddress);
            members.setMemberFirstName(firstname);
            members.setMemberMiddleName(middlename);
            members.setMemberLastName(lastname);
            ...
            members.setMemberPassword(password);
            members.setBusinessCategoryId(businesscategoryid);
            members.setBusinessCategoryName(aboutBusiness);
            members.setMemberDateOfBirth(dateofbirth);
            members.setMemberCompanyKeywords(businesskeywords);
          //  members.setMember_company_description(member_company_description);
	...
	@RequestMapping(value = "/editProfilePicture2", method = RequestMethod.POST)
    public String editProfilePicture2(@RequestParam(value = "profilepicture", required = false) MultipartFile profilepicture,
            int memberid, String profileimage, int valuex, int valuey, int valuew, int valueh,
            int rotaryyearid, int businesscategoryid,
			String firstname, String middlename, String lastname, String dateofbirth, 
			
			String email,String password,String businesskeywords,
            HttpServletRequest request, HttpSession session)
            throws IOException {
        logger.info("Inside Edit Member Contact Detail Controller");
	...
	int count =0;
	@RequestMapping(value = "/addmemberdetail1", method = RequestMethod.POST)
	public synchronized int addmemberdetail1(String firstname, String middlename, String lastname,
			 String mobile, String email,String companyname,int memberclubname,
			int fellowship_id,int kaipan ,HttpSession session, HttpServletRequest request) throws IOException {
		logger.info("*****************Inside Add Member Detail Controller**********************");
	   ...
	   String membershipid="";
		 ...
		 * if(fellowship_id==1) {
		 * 
		 * typemem = "RMBV"; } else if(fellowship_id==2) { typemem = "RMBS"; }
		 * 
		 * else if(fellowship_id==3) { typemem = "RMBK"; }
		 * 
		 * else { typemem = "OTHERS"; }
		 */
		if(seq >= 0 && seq <= 9) {
...
/*
	...
	*/	
		...
		int user_type_id=2;
					...
					members.setMemberMiddleName(middlename);
					members.setMemberLastName(lastname);
					members.setJoiningDate(joindate);
					members.setTenurePlan(tenurePlan);
					members.setUser_role_id(user_role_id);
					members.setUserTypeId(user_type_id);
					members.setMemberMobileNumber(mobile);
					members.setMemberEmail(email);
					members.setSequence(seq);
					members.setMembershipNumber(membershipid);
					members.setStatus(status);
					members.setCreatedBy(1);
					members.setIpAddress(ipAddress);
					members.setFellowship_id(fellowship_id);
					members.setMemberType(typemem+" Members");
					members.setMemberBarcode(barcodeImage);
					members.setMemberQrcode(qrcodeimage);
					members.setClubId(memberclubname);
					members.setMemberCompanyName(companyname);
					
					memberdao.addMemberDetail1(members);
	...
	// Fellowship Wise Member Total 
	
	@RequestMapping(value = "/getChapterSummaryByDate", method = RequestMethod.GET, produces = "application/json")
	public List<Members> getChapterSummaryByDate(String fromdate, String todate, HttpServletRequest request, HttpSession session) {
		...
		if(role_id == 1) {
		 ...
		 members = memberdao.getChapterSummaryByDate(fromdate, todate,fellowship_id);
		}
		else {
			int fellowship_id = Integer.parseInt(session.getAttribute("fellowshipId").toString());
			 members = memberdao.getChapterSummaryByDate(fromdate, todate,fellowship_id);
	...
	@RequestMapping(value = "/getChapterSummaryByDateFront", method = RequestMethod.GET, produces = "application/json")
	public List<Members> getChapterSummaryByDate1(String fromdate, String todate, HttpServletRequest request, HttpSession session) {
		logger.info("***** getChapterSummaryByDateFront*****");
	...
	@RequestMapping(value = "/getChapterSummaryByDate1", method = RequestMethod.GET, produces = "application/json")
	public List<Members> getChapterSummaryByDate1(String fromdate, String todate,int fellowship_id, HttpServletRequest request, HttpSession session) {
		logger.info("***** GET CHAPTER SUMMARY BY DATE *****");
		
		List<Members>  members = memberdao.getChapterSummaryByDate(fromdate, todate,fellowship_id);
