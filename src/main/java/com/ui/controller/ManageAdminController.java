...
public class ManageAdminController {
	...
	ManageAdminDAO manageAdminDAO;
	 private static final Logger logger = LoggerFactory.getLogger(ManageAdminController.class);
		...
		@GetMapping(value = "getAllMemberByFellowship")
		  public List<ManageAdmin> getAllMemberByFellowship(int fellowship_id,HttpServletRequest request) {
		      logger.info("*****getAllMemberByFellowship*****");
		    //  return manageAdminDAO.getAllMemberByFellowshipId(fellowship_id);
		      return manageAdminDAO.getAllMemberByFellowship(fellowship_id);
		  }
