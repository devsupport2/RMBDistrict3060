...
public class MembersCommitteeController {
	...
	@RequestMapping(value="/MembersCommitteeBYFellowship", method= RequestMethod.GET, produces = "application/json")
	public List<MembersCommittee> MembersCommittee1(int fellowship_id,HttpServletRequest request)
	{
		logger.info("********** INSIDE ALL MembersCommitteeBYFellowship **********");		
		List<MembersCommittee> MembersCommittee = memberscommitteedao.getAllMembersCommitteeByFellowshipId(fellowship_id);	
		return MembersCommittee;
	}
